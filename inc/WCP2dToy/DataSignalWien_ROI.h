 ...
 * @brief Provides data signal processing functionality for Wien ROIFDS
 * @details This class inherits from WCP::FrameDataSource and offers methods for 
 *          data signal processing, including deconvolution and ROI calculation
