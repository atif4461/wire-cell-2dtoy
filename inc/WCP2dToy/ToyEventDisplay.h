 ...
 * @brief A class responsible for displaying toy events in a graphical representation.
 * @details This class provides functionality for initializing and drawing various elements 
 *          of an event display, including cell charges, slices, wires, points, and cells.
  
 * @class Array1D
 * @brief A one-dimensional array class used for storing and manipulating data.
 * @details This class serves as a replacement for the KokkosArray class and provides basic 
 *          operations for working with one-dimensional arrays.
 
 * @class Array2D
 * @brief A two-dimensional array class used for storing and manipulating data.
 * @details This class serves as a replacement for the KokkosArray class and provides basic 
 *          operations for working with two-dimensional arrays.
 
 * @class SyclArray
 * @brief A class providing functionality for performing operations on arrays using SYCL.
 * @details This class offers methods for copying and manipulating data between host and device,
 *          enabling efficient computation and data transfer.
