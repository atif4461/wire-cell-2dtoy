...
/** * @brief Class responsible for displaying toy events within a specified TPad.
 *
 * This class utilizes ROOT graphics primitives such as TH2F, TGraph, TPolyLine,
 * and others to visualize various aspects of detector geometry and reconstructed
 * data. It interfaces with the WCP namespace classes like GeomDataSource,
 * Slice, PointValueVector, etc., to fetch and render geometric and physical
 * information about the detector elements and their interactions.
