...
/** * @brief Class responsible for displaying toy events within a ROOT TPad.
 *
 * This class provides methods to initialize and visualize various components of a simulated event,
 * including slices, wires, points, cells, and their associated charges. It leverages data sources
 * such as GeomDataSource and DetectorGDS for geometric information and employs graphical primitives
 * like TH2F, TGraph, and TPolyLine for rendering.
