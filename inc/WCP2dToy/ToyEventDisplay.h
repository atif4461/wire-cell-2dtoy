 ...
 * @brief A class responsible for displaying toy events in a graphical interface.
 * 
 * This class provides functionality for initializing and drawing various components of an event display,
 * including cell charges, slices, wires, points, and selections of cells. It also allows for setting thresholds
 * and clearing the display data.
