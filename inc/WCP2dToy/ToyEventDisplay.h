...
/** * @brief Class responsible for creating and managing a toy event display using ROOT graphics primitives.
 *
 * This class utilizes a TPad for rendering graphical elements related to detector geometry,
 * cell charges, slices, wires, and other components of an event. It leverages data sources
 * like GeomDataSource and DetectorGDS to fetch geometric information and cell charge data.
