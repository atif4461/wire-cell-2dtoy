...
/**
 * @class WCPHolder
 * @brief Holds collections of geometric wires and cells.
 *
 * Provides methods for adding and retrieving wires and cells,
 * as well as tracking counts of added items.
...
*/ 
  ...
  public:
    ...
    void AddWire_No(){wire_no++;};
    void AddCell_No(){cell_no++;};
