...
namespace WCP2dToy{
/**
 * @brief Frame data source for pad detector data
  
 * @class pdDataFDS
 * @brief Provides access to pad detector frame data
 * @details Manages frame data for pad detectors including geometry and event data
