...
/**
 * @class ToyCrawler
 * @brief Provides functionality for crawling through merge space cells to form clusters and tracks.
  
 * @class ToyCrawler
 * @details This class contains methods for creating cluster tracks, forming graphs, merging tracks, 
 *          and updating maps related to merge space cells and cluster tracks.
