...
/**
 * @class ToyCrawler
 * @brief Provides functionality for crawling through merged space cells to form cluster tracks.
  
 * @class ToyCrawler
 * @details This class contains methods for creating cluster tracks, forming graphs, merging tracks, 
 *          and updating maps related to merged space cells and cluster tracks.
