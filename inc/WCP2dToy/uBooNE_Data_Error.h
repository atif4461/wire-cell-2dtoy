...
namespace WCP2dToy{
/**
 * @brief Class representing data error handling for uBooNE data source
  
 * @class uBooNEDataError
 * @brief Provides functionality for managing data errors in uBooNE data source
 * @details Handles data retrieval and processing for uBooNE data source
