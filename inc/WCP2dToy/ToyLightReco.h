...
/**
 * Struct representing a PMT discriminator data structure containing channel information, 
 * timestamp, waveform, saturation status, isolation status, and gain setting * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
  struct pmtDisc{
    short channel;
    double timestamp;
...
/**
 * Struct to compare two pmtDisc objects based on their timestamps
...
/**
 * Struct to compare pmtPairs based on timestamp order
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * @class ToyLightReco
 * @brief A class for toy light reconstruction
 * @details Provides methods for loading event data, getting histograms, and processing waveforms
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
  class ToyLightReco{
  public:
