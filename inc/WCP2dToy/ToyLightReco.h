...
/**
 * @brief Data structure representing a photomultiplier tube discriminator.
 * 
 * This struct holds information related to a single photomultiplier tube 
 * discriminator including its channel number, timestamp, waveform, saturation status,
 * isolation status, and gain status.
...
/**
 * @brief Custom comparison struct for sorting pmtDisc objects by timestamp
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Custom comparison struct for ordering pmtPairs by timestamp
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @class ToyLightReco
 * @brief Class for light reconstruction in the Toy experiment
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
  class ToyLightReco{
  public:
