...
/** * @brief A specialized tiling class designed for efficient memory usage during wire cell processing.
 *
 * Inherits from WCP::TilingBase, LowmemTiling implements optimized algorithms for handling wire cell data structures,
 * focusing on minimizing memory footprint while maintaining computational efficiency. It manages geometric wire and cell selections,
 * performs merging operations, and handles charge calculations for wires and cells.
