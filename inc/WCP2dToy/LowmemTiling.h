...
/**
 * @class LowmemTiling
 * @brief A class representing a low memory tiling strategy for wire cell reconstruction.
 *
 * This class provides an efficient way to manage wire cells and perform operations such as merging and dividing wires.
 * It also includes methods for calculating wire charges and managing cell-wire relationships.
