...
/**
 * @brief Class representing low memory tiling.
 *
 * This class inherits from WCP::TilingBase and provides functionality for 
 * low memory tiling, including methods for forming bad merge wires, 
 * initializing bad cells, checking bad cells, resetting cells, and more.
 *
 * It also includes maps for storing relationships between cells and wires, 
 * such as cell_wires_map and wire_cells_map.
