...
/**
 * @class LowmemTiling
 * @brief A class representing a tiling object with low memory usage.
 * @details This class provides methods for creating and manipulating tilings, including merging wires, calculating charges, and managing cell and wire relationships.
