...
/**
 * @brief Class representing a library for photon energy reconstruction.
 *
 * Provides methods for calculating XYZQ values, shifted XYZQ values,
 * minimum and maximum X values, and checking if a point is within
 * the fiducial volume or at the boundary. Also includes methods
 * for converting points to voxel IDs and retrieving photon library maps.
