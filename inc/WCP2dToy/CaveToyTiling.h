...
/**
 * @class CaveToyTiling
 * @brief A class representing a cave tiling object, inheriting from MergeToyTiling
 * @details This class provides functionality for creating and managing cave tilings,
 *          including cell removal and storage of cell and wire maps
