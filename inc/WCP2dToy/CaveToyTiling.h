...
namespace WCP2dToy{
/**
 * @brief A class representing cave toy tiling functionality.
 *
 * This class extends the MergeToyTiling class and provides additional features
 * for managing toy tilings, including cell removal and merging.
