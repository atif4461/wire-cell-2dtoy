...
/** * @brief Class responsible for handling the tracking process in a toy simulation environment.
 *
 * This class manages the creation, manipulation, and organization of tracks, vertices, and showers
 * within a simulated tracking system. It utilizes graph theory-based methods to construct track seeds,
 * taking into account imperfections such as additional charge information. The class provides
 * functionalities for iterating over track merges, creating vertices, removing duplicates, organizing
 * tracks, associating tracks with vertices, cleaning up vertices, crawling through clusters, checking
 * containment, examining vertices, updating maps, performing fine tracking, cleaning up bad tracks,
 * dealing with wiggled tracks, forming parallel tiny tracks, conducting parallel tracking, reconstructing
 * track showers, cleaning up showers, finding cosmic rays, and filling maps with geometric properties
 * of tracks.
