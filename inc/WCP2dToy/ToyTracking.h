...
/**
 * @class ToyTracking
 * @brief Class representing toy tracking functionality
 * @details Provides methods for iterating merge tracks, merging tracks, creating vertices, 
 *          removing same tracks, breaking tracks, organizing tracks, associating tracks, 
 *          cleaning up vertices, crawling, checking vertices, examining vertices, 
 *          updating maps, fine tracking, cleaning up bad tracks, dealing with wiggly tracks, 
 *          growing tracks to fill gaps, forming parallel tiny tracks, performing parallel tracking, 
 *          tracking shower reconstruction, cleaning up showers, performing single shower reconstruction, 
 *          finding cosmics, filling maps, and accessing various track and vertex selections
