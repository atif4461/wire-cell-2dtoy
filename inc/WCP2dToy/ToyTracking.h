...
/** * @brief Class responsible for handling the tracking process within a toy model framework.
 *
 * This class manages various aspects of particle tracking including creating, merging,
 * organizing, and cleaning up tracks and vertices. It interacts with other components such as
 * ToyCrawler to perform detailed operations related to track reconstruction and shower identification.
