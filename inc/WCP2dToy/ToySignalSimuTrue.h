...
namespace WCP2dToy {
/**
 * @class ToySignalSimuTrueFDS
 * @brief Simulated true Frame Data Source class
 *
 * This class provides a simulated true frame data source for signal simulation purposes.
 * It inherits from WCP::FrameDataSource and offers methods for jumping to specific frames,
 * saving data, and accessing various parameters.
