 ...
 * @brief Class representing a Kalman filter for toy matrices with additional constructors.
 *
 * This class extends the basic functionality of the Kalman filter with additional
 * constructors to accommodate different initialization scenarios.
