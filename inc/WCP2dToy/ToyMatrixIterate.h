 ...
 * @brief Provides iteration functionality over toy matrices.
  
 * @class Array1D 
 * @brief Represents a one-dimensional array with basic operations.
 
 * @class Array2D 
 * @brief Represents a two-dimensional array with basic operations.
 
 * @class SyclArray 
 * @brief Offers an interface for performing operations on arrays using SYCL.
 
 * @class KokkosArray 
 * @brief Serves as a wrapper for Kokkos views providing array-like functionality.
