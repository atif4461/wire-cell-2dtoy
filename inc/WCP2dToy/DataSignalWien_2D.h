...
namespace WCP2dToy {
/**
 * @class DataSignalWien2DFDS
 * @brief A class inheriting from WCP::FrameDataSource to provide signal processing functionality
 * 
 * This class provides methods for signal processing and data retrieval, including getting rms values for different planes
