...
namespace WCP2dToy{
/** * @brief Class representing a toy metric for evaluating cell selection and matrix operations.
 *
 * This class provides functionality to add geometric cells, matrices, and charge maps,
 * print evaluation results, and manage solving conditions.
