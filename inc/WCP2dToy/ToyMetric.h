...
namespace WCP2dToy{
/** * @brief Class representing a toy metric for evaluating cell-based metrics in a simulation environment.
 *
 * This class provides functionality to add geometric cells, evaluate their charges, and print out various statistics related to these evaluations.
