...
namespace WCP2dToy{
/**
 * @brief Class representing a toy metric calculation.
 *
 * This class encapsulates the functionality for calculating and managing 
 * toy metrics, including adding cell selections, solving conditions, 
