...
namespace WCP2dToy{
/**
 * Class representing data source after ROI processing for uBooNE experiment
  
 * Class providing functionality for managing signal ROIs in uBooNE data
  
 * Class encapsulating data and operations for uBooNE data after ROI application
  
 * Data source class for uBooNE experiment with ROI processing capabilities
