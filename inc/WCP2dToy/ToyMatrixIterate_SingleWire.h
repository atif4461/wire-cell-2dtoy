 ...
 * @brief Iterates over a toy matrix for a single wire
 * @details Provides functionality for iterating over a toy matrix and performing operations related to a single wire
