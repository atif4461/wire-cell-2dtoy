...
/** * @brief Class for tracking and reporting memory usage events.
 *
 * This class provides functionality to record memory usage events along with associated messages,
 * allowing for detailed monitoring and summarizing of memory consumption over time.
