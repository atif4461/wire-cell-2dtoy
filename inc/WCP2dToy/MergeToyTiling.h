...
namespace WCP2dToy{
/** * @brief This class extends ToyTiling to facilitate merging operations on geometric cells within a detector geometry.
 *
 * The MergeToyTiling class provides functionality to merge geometric cells based on specified strategies and conditions,
 * particularly useful in the context of particle detection systems such as those utilizing Liquid Argon Time Projection Chambers (LArTPCs).
 * It includes methods for forming wire maps, performing further merges, converting between time and distance, and handling ghost cells.
