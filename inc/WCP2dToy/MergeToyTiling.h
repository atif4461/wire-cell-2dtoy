...
namespace WCP2dToy{
/** * @brief Extends ToyTiling to facilitate merging operations on geometric cells and wires.
 *
 * This class provides functionality to merge geometric cells and wires according to specified strategies,
 * convert between time slices and distances, and manage various collections of cells and wires.
