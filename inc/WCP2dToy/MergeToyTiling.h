...
namespace WCP2dToy{
/**
 * @class MergeToyTiling 
 * @brief This class represents a merging of toy tilings in a detector.
 * @details It provides methods for forming wire maps, getting cell selections, 
 *          and performing further merges.
