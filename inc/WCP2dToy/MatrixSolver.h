...
/**
 * @class MatrixSolver
 * @brief Solves matrix equations for charge calculation in a geometric cell selection.
 * 
 * This class provides methods for solving matrix equations to calculate charges 
 * in a geometric cell selection. It includes functions for direct and L1 norm 
 * minimization solves, as well as accessors for various parameters such as chi-squared values,
 * degrees of freedom, and solve flags.
