...
namespace WCP2dToy{
/** * @brief Solves matrix equations related to charge distribution in a liquid argon time projection chamber (TPC).
 *
 * This class provides methods to perform both direct and L1 regularized solutions for charge distribution within geometric cells,
 * utilizing wire charge maps and other geometric mappings. It calculates chi-squared values and degrees of freedom for these solutions.
 * Additionally, it offers access to various internal parameters and indices used during the solving process.
