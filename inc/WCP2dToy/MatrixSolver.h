...
namespace WCP2dToy{
/**
 * @brief Provides functionality for solving matrix-related problems in the context of geometric cells and wires.
 * 
 * This class encapsulates data and operations necessary for solving systems of linear equations,
 * including setting up matrices, performing solves, and extracting results.
 * It also provides access to various parameters and indices related to the solution process.
  
 * @brief Represents a solver for matrix-based problems, offering methods for setup, solution, and result retrieval.
 * 
 * This class serves as a central component in the process of solving matrix-related problems,
 * providing a structured approach to managing data, performing computations, and accessing outcomes.
