...
namespace WCP2dToy {
/**
 * @class ToySignalSimuFDS
 * @brief Simulates signal data source for frames
 * @details Provides functionality for simulating signal data sources 
 *          including noise and electronics configuration
  
 * @class FrameDataSource
 * @brief Abstract base class for frame data sources
 * @details Defines interface for accessing frame data
 
 * @class DetectorGDS
 * @brief Geometrical data source for detectors
 * @details Represents geometrical properties of detectors
 
 * @class ElectronicsConfig
 * @brief Configuration for electronics
 * @details Holds settings for electronic components
 
 * @class GenNoise
 * @brief Generator for random noise
 * @details Produces simulated noise patterns
