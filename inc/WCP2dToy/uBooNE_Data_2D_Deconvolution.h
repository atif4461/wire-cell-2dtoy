...
namespace WCP2dToy{
/**
 * @class uBooNEData2DDeconvolutionFDS
 * @brief A class representing a 2D deconvolution frame data source for uBooNE data.
 *
 * This class provides methods for accessing and manipulating 2D deconvolution data,
 * including chirp maps, Gaussian and Wiener filter responses, and more.
