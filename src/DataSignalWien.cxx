...
/**
 * @brief Constructor for DataSignalWienFDS class.
 * 
 ...
 * @param umap U-plane chirp map object.
 * @param vmap V-plane chirp map object.
 * @param wmap W-plane chirp map object.
...
/**
 * Saves the signal data to a ROOT file named temp_wien_root
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 * and fills the frame with the corresponding data from the FDS.
 *
...
/**
 * @brief Destructor for DataSignalWienFDS class
 * 
 * Releases dynamically allocated memory for signal processing objects
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
