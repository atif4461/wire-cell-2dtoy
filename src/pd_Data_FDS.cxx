 ...
 * Constructor for pdDataFDS class 
 * @param gds Geom data source object
 * @param hu_decon histogram of deconvoluted u plane data
 * @param hv_decon histogram of deconvoluted v plane data
 * @param hw_decon histogram of deconvoluted w plane data
 * @param eve_num event number
 */
// The above comment was written by an LLM. 
