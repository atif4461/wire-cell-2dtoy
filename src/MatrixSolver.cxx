 ...
 * 
 * This constructor initializes the MatrixSolver object with the given parameters.
 * It sets up the index maps for merged cells, merged wires, and single wires,
 * and constructs the matrices and vectors needed for the matrix solving process.
 * 
 * @param allmcell A reference to a GeomCellSelection object containing all merged cells.
 * @param mwires A reference to a GeomWireSelection object containing all merged wires.
 * @param cell_wire_map A reference to a WCP::GeomCellMap object mapping cells to wires.
 * @param wire_cell_map A reference to a WCP::GeomWireMap object mapping wires to cells.
 * @param wire_charge_map A reference to a WCP::WireChargeMap object containing wire charges.
 * @param wire_charge_error_map A reference to a WCP::WireChargeMap object containing wire charge errors.
...
/**
 * @brief Solves the matrix using L1 regularization.
 *
 * This function takes a map of cell weights as input and solves the matrix
 * using L1 regularization. It sets up the Lasso model, fits the data,
 * and calculates the solved charges and degrees of freedom.
 *
 * @param cell_weight_map A map of cell weights where the key is a pointer to a GeomCell
 *                        and the value is the corresponding weight.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Retrieves all cell selections from the matrix cell map.
 * @return A list of geometric cell selections.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Calculates the charge of a MergeGeomCell
 * @param mcell pointer to the MergeGeomCell
 * @return the calculated charge of the cell
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Retrieves the index of a wire in the master wire map.
 * 
 * Searches for the given wire in the master wire map and returns its corresponding index.
 * If the wire is not found, returns -1.
 * 
 * @param wire The wire to search for in the master wire map.
 * @return The index of the wire in the master wire map, or -1 if not found.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Returns the W value at a specified index.
...
/**
 * @brief Retrieves the G value at specified indices.
 * 
 * @param index_mw Index in the mw dimension.
 * @param index_mc Index in the mc dimension.
 * @return The G value at the specified indices if within bounds, otherwise 0.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Destructor for MatrixSolver class, responsible for deallocating memory 
 * allocated to various member variables to prevent memory leaks.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
