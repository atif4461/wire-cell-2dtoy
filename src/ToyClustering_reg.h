 ...
 * and connectivity. It iteratively merges clusters until a stopping criterion
 * is met.
 *
 ...
 * @param length_cut The minimum length required for a cluster to be considered
 * @param flag_enable_extend Flag to enable extension of clusters
...
/**
 * @class WCP2dToy
 * @brief This class contains methods for clustering points in 2D space.
  
 * @fn Clustering_1st_round
 * @brief First round of clustering for two clusters.
 * @param cluster1 First cluster.
 * @param cluster2 Second cluster.
 * @param length_1 Length of first cluster.
 * @param length_2 Length of second cluster.
 * @param length_cut Cut-off length for clustering.
 * @param flag_enable_extend Flag to enable extension.
