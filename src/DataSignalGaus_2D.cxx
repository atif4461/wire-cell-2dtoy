...
/**
 * @brief Jumps to a specific frame number in the data signal gaus 2D FDS.
 * 
 * This function clears the current frame, jumps to the specified frame number,
 * and fills the frame data with the corresponding signals.
 * 
...
/**
 * @brief Destructor for DataSignalGaus2DFDS class
 * 
