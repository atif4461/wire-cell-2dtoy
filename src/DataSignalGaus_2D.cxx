#include "WCP2dToy/DataSignalGaus_2D.h"
...
/**
 * @brief Constructor for DataSignalGaus2DFDS class
 * @param[in] fds Frame data source
 ...
 * @param[in] time_offset_uv Time offset for uv plane
 * @param[in] time_offset_uw Time offset for uw plane
...
int WCP2dToy::DataSignalGaus2DFDS::size() const{
  return max_frames;
}

/**
 * Saves the data signal to a root file named temp_gausroot 
 */
// The above comment was written by an LLM. 
