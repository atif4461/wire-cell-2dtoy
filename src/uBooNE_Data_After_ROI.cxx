 ...
 * 
 * @brief Removes unwanted ROIs from the collection
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
 ...
 *
 * @param[in] previous ROI to be unlinked
 * @param[in] next ROI to be unlinked
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
 ...
 *
 * @param[in] prev_roi The previous signal ROI.
 * @param[in] next_roi The next signal ROI.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Shrinks the Region Of Interest (ROI) by checking nearby ROIs and updating the maps accordingly.
 *
...
/**
 * @brief Jumps to a specific frame number and processes the data accordingly.
 *
 * @param frame_number The target frame number to jump to.
 * @return The index of the current frame after processing.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
 ...
 * - If a neighboring ROI's start bin is less than the current ROI's start bin,
 *   updates the current ROI's extended start bin to the neighboring ROI's start bin.
 * - If a neighboring ROI's end bin is greater than the current ROI's end bin,
 *   updates the current ROI's extended end bin to the neighboring ROI's end bin.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Checks ROIs in the data after ROI processing.
 *
 * This function iterates through the loose ROIs in the U and V planes,
 * checks for overlaps between adjacent channels, and unlinks ROIs that do not overlap.
 *
 * @param none
 * @return void
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
