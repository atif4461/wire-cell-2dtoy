...
/**
 * Constructor for initializing member variables with provided Frame Data Source, Geometry Data Source, ROI data, and rebining factor.
 *
 * @param fds Reference to Frame Data Source object.
 * @param gds Reference to Geometry Data Source object.
 * @param rois Reference to ROI data object.
 * @param rebin Rebinning factor for data processing.
...
/**
 * Clears data structures after region of interest processing.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Cleans up Regions Of Interest
 *
 * This function cleans up the Regions Of Interest (ROIs) by removing unwanted regions
 * and updating the corresponding maps.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Cleans up induction ROIs by removing bad regions of interest.
 *
 * This function iterates through all ROIs in both U and V planes,
 * identifies bad ROIs based on certain criteria such as being isolated,
 * having low average heights, or not meeting a specified threshold,
 * and removes them from the list of ROIs. It also updates the front and
 * back ROI maps accordingly.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Cleans up the collection of Regions Of Interest (ROIs).
 *
 * This function filters out weak ROIs that do not meet certain criteria,
 * such as having a low average height or not being connected to other strong ROIs.
 *
 * It uses a two-step approach: first, it identifies strong ROIs that have a high average height
 * or contain peaks above a certain threshold; second, it removes weak ROIs that are not
 * connected to these strong ROIs.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Breaks down an ROI into smaller sub-ROIs based on zero crossings.
 *
 * This function takes an input SignalROI pointer, breaks it down into multiple
 * sub-ROIs wherever there are zero crossings, and updates the internal lists
 * and maps accordingly.
 *
 * @param roi The input SignalROI to be broken down.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Breaks down an ROI into sub-regions of interest.
 *
 * This function takes a SignalROI pointer and a float value as input,
 * and modifies the ROI's contents accordingly.
 *
 * @param roi Pointer to the SignalROI object to be broken down.
 * @param rms Float value representing the root mean square.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Unlinks two signal ROIs in the front and back ROI maps.
 * 
 * This function removes the link between two adjacent signal ROIs in the 
 * front_rois and back_rois maps. It checks if the previous ROI exists in 
 * the front_rois map and if the next ROI exists in the back_rois map, and 
 * then erases the corresponding links.
 * 
 * @param prev_roi The previous signal ROI.
 * @param next_roi The next signal ROI.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 *
 * @param prev_roi The previous ROI to be linked.
 * @param next_roi The next ROI to be linked.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Breaks down Regions Of Interest into smaller segments
 * 
 * This function takes the regions of interest from the u and v planes,
 * breaks them down further based on certain conditions, and stores
 * the broken down regions in a single collection.
 * 
 * @param none
 * @return void
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
...
/**
 * Shrinks the Region Of Interest in the uBooNE data.
 *
 * This function takes a SignalROI object as input, checks its neighboring ROIs,
 * and updates the ROI boundaries accordingly.
 *
...
/**
 * Shrinks all Regions of Interest ROI in the data after applying 
 * selection criteria to reduce their spatial extent * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Generates merged Regions Of Interest ROIs for U and V planes.
 *
 * This function iterates through the loose ROIs in the U and V planes,
 * identifies the tight ROIs that are not contained within the loose ROIs,
 * duplicates these tight ROIs as loose ROIs, and updates the containment
 * relationships between the loose ROIs.
 *
 * @param none
 * @return void
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
...
/**
 * @brief Jump to a specific frame number in the uBooNE data.
 *
 * This function clears the current frame and jumps to the specified frame number.
 * It loads the new frame's traces and updates the ROI information accordingly.
 *
 * @param frame_number The frame number to jump to.
 * @return The index of the jumped-to frame.
 
int WCP2dToy::uBooNEDataAfterROI::jump(int frame_number){... }* This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Extends Regions Of Interest in the U, V, and W planes.
 *
 * This function iterates through each channel in the U, V, and W planes,
 * extending the start and end bins of each Region Of Interest (ROI).
 * It checks neighboring ROIs and adjusts their boundaries accordingly.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Checks regions of interest in the signal data.
 *
 * This function iterates through the loose regions of interest in the u and v planes,
 * checks for overlaps between them, and unlinks those that do not overlap within a certain threshold.
 *
 * @param none
 * @return void
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
...
/**
 * @brief Tests ROIs after ROI processing.
 *
 * This function tests the ROIs after they have been processed,
 * checking for connections between adjacent channels.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
