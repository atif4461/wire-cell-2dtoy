 ...
 *
 * @param[in] fds Frame data source object.
 * @param[in] gds Geometry data source object.
 * @param[in] rois ROI data object.
 * @param[in] rebin Rebinning factor.
...
/**
 * Clears all stored ROI data structures by deallocating memory and resetting containers.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * Cleans up Regions Of Interest (ROIs) by removing unwanted regions and updating maps accordingly.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
 ...
 *
 * This function iterates over all loose ROIs, checks their properties,
...
/**
 * Cleans up the collection of Regions Of Interest (ROIs) by removing those that do not meet certain criteria.
 *
 * The function first identifies "good" ROIs that have peaks above a certain threshold or have an average height above a mean threshold.
 * It then removes any ROIs that are not in the list of good ROIs and are not connected to a good ROI.
 *
 * @return None
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * Breaks down a given ROI into smaller sub-ROIs based on certain conditions.
 *
...
/**
 * @brief Breaks down a ROI into smaller sub-ROIs based on signal patterns.
 *
 * @param roi Pointer to the SignalROI object to be broken down.
 * @param rms Root mean square value used as a threshold.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * Unlinks two signal ROIs from their respective lists.
 *
 * @param prev_roi the previous ROI to be unlinked
 * @param next_roi the next ROI to be unlinked
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * Links two signal ROIs together after ROI processing.
 *
 * @param[in] previous ROI to link from
 * @param[in] next ROI to link to
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * Breaks down Regions Of Interest ROI into smaller components
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * @brief Shrinks the Region Of Interest (ROI) based on certain conditions.
 *
 * This function takes a SignalROI pointer as input, checks for tight ROIs, 
 * front ROIs, and back ROIs, and updates the corresponding maps accordingly.
 *
 * It also creates a new ROI and updates the lists of loose ROIs.
 *
 * @param roi A pointer to the SignalROI object to be shrunk.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * Shrinks all Regions of Interest ROI after applying loose selection criteria
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * @brief Generates merged ROIs after ROI process
 *
 * This function finds tight ROIs that are not contained within loose ROIs,
 * duplicates them as loose ROIs, and updates various maps such as contained,
 * front, and back maps accordingly.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
 ...
 * @return The current frame index after jumping.
 
int WCP2dToy::uBooNEDataAfterROI::jump(int frame_number){...}* This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * @brief Extends the Regions Of Interest (ROIs) for the u, v, and w planes.
 *
 * This function iterates over each channel in the u, v, and w planes,
 * sorts the ROIs, and extends their boundaries based on neighboring ROIs.
 *
 * @details
 * - Initializes the extended bin ranges for each ROI to match their original bin ranges.
 * - For each plane, loops through the sorted ROIs and updates their extended bin ranges
 *   by comparing with neighboring ROIs.
 * - If a neighboring ROI's start bin is earlier than the current ROI's start bin,
 *   updates the current ROI's extended start bin to the earlier value.
 * - If a neighboring ROI's end bin is later than the current ROI's end bin,
 *   updates the current ROI's extended end bin to the later value.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * Checks ROIs in the u and v planes and unlinks overlapping regions.
 *
 * This function iterates through the loose ROIs in both the u and v planes,
 * checking for overlaps with neighboring regions. If an overlap is found,
 * the regions are left linked; otherwise, they are unlinked.
 *
 * @param none
 * @return void
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
...
/**
 * @brief Tests ROIs for u, v, and w planes
 *
 * This function iterates over all channels in the u, v, and w planes,
 * checking for matching ROIs between adjacent channels.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
