...
/**
 * @brief Constructor for ToySignalSimuTrueFDS class
 * 
 * Initializes the ToySignalSimuTrueFDS object with FrameDataSource, 
 * GeomDataSource, number of bins per frame, total number of frames, 
 * and smearing flag.
 * 
 * @param fds1 FrameDataSource object
 ...
 * @brief Constructor for ToySignalSimuTrueFDS class
 * 
 * Initializes the ToySignalSimuTrueFDS object with the given parameters
 * 
 * @param fds1 Frame data source
 * @param gds Detector geometry definition
 * @param bins_per_frame1 Number of bins per frame
 * @param nframes_total Total number of frames
 * @param flag_smear Flag indicating whether to smear or not
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Saves simulation true FDS data to a ROOT file.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 *
 * This function simulates a signal for a given frame number by resetting the histograms,
 * applying filters, and filling the frame data.
 *
 * @param frame_number The number of the frame to simulate.
...
/**
 * Destructor for the ToySignalSimuTrueFDS class.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
