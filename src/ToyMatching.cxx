...
/**
 * @brief Converts a 3D point to a voxel ID.
 *
 * This function takes a 3D point as input and returns a unique voxel ID.
 * The conversion is done based on the coordinates of the point.
 *
...
/**
 * @brief Performs TPC-light matching.
 *
...
/**
 * @brief Organizes matched bundles of flash and cluster data.
 *
 * This function takes in a selection of flash TPC bundles and organizes them into a coherent set.
 * It uses various metrics such as chi-squared and distance to determine the best matches between flashes and clusters.
 *
 * The function also removes duplicate or redundant bundles and updates the flash associations accordingly.
 *
 * @param results_bundles The input selection of flash TPC bundles to be organized.
 * @param cos_pe_low Lower bound for cosine of angle between photon and electron directions.
 * @param cos_pe_mid Middle bound for cosine of angle between photon and electron directions.
 * @param fc_bundles_map Map of flash-cluster associations.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
