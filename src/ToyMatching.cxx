 ...
 *
 * This function takes a 3D point p as input and returns its corresponding voxel ID.
 * The conversion involves scaling and rounding the x, y, and z coordinates 
 * of the point to fit within a 3D grid of voxels.
 *
 * @param p The 3D point to convert.
 * @return The voxel ID corresponding to the input point.
...
/**
 * @brief Performs charge-light matching for a given set of TPC clusters and PMT flashes.
 *
 * @param eventTime Time of the event.
 * @param time_offset Offset in time.
 * @param nrebin Rebinning factor.
 * @param pl Photon library.
 * @param group_clusters Map of clustered TPC clusters.
 * @param flashes Selection of PMT flashes.
 * @param run_no Run number.
 * @param flag_data Flag indicating whether data or MC.
 * @param flag_add_light_yield_err Flag indicating whether to add light yield error.
 * @param flag_timestamp Flag indicating whether timestamp is available.
 * @return Selected FlashTPCBundle objects representing matched TPC clusters and PMT flashes.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * @brief Organizes matched bundles based on flash information and selection criteria.
 *
 * @param results_bundles The input collection of FlashTPCBundle objects to be organized.
 * @param cos_pe_low Low cosine values for PE calculation.
 * @param cos_pe_mid Mid cosine values for PE calculation.
 * @param fc_bundles_map Map of flash-cluster pairs to FlashTPCBundle objects.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
