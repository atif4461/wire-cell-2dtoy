...
/**
 * @brief Function to determine if two clusters should be merged based on distance and length criteria.
 *
 ...
 * @param length_cut Threshold length for considering merger.
