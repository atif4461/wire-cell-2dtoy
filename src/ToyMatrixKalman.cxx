...
/**
 * Constructor for ToyMatrixKalman class 
 * @param already_removed1 vector of integers representing points already removed 
 * @param no_need_remove1 vector of integers representing points that do not need removal 
 * @param toymatrix reference to ToyMatrix object 
 * @param check integer value for checking 
