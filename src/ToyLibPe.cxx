...
/**
 * @brief Constructor for ToyLibPe class
 * @param root_file Input root file path
...
/**
 * Converts a 3D point to a unique voxel ID.
 *
 * This function takes a 3D point as input and returns a unique integer identifier
 * corresponding to the voxel that contains the point. The conversion is done
 * based on the coordinates of the point and the dimensions of the voxels.
 *
 * @param p The 3D point to be converted.
 * @return A unique integer identifier for the voxel containing the point.* This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Returns the mapping of library to PMT.
 *
 * @return A map containing the library to PMT mappings.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Returns the mapping of pmt to lib.
 *
 * @return A map where keys are pmt values and values are corresponding lib values.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Returns the photon library as a 3D vector of pairs containing opchannel and visibility values.
 *
 * @return A 3D vector representing the photon library.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Calculates weighted average of X, Y, Z coordinates and total energy deposit
 * @param x Vector of X coordinates
 * @param y Vector of Y coordinates
 * @param z Vector of Z coordinates
 * @param e Vector of energy deposits
 * @return Vector containing weighted averages of X, Y, Z and total energy deposit
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Calculates minimum and maximum x-values from a vector of floats.
 *
 * This function takes a pointer to a vector of floating-point numbers as input,
 * finds the smallest and largest elements in the vector, and returns them as a pair.
 *
 * @param x Pointer to a vector of floating-point numbers.
 * @return A pair containing the minimum and maximum x-values.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Calculates the minimum and maximum x-values in a vector after applying an offset.
 *
 * @param x Pointer to a vector of floating point numbers representing x-coordinates.
 * @param xOffset Offset value to be subtracted from the x-coordinates.
 * @return Pair containing the minimum and maximum x-values after applying the offset.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Checks if a given pair of floats is within the fiducial volume in the x direction.
 *
 * @param x Pair of float values representing the coordinates to check.
 * @return True if the coordinates are within the fiducial volume, false otherwise.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Checks if a pair of float values is at the boundary.
 *
 * @param x A pair of float values to be checked.
 * @return True if the pair of float values is at the boundary, false otherwise.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Calculates predicted PMT light distribution from cluster find Pe distance
 * 
 ...
 * @param[in] e Vector of energies of cluster points
 * @param[in] xOffset X offset value
 * @param[in] yOffset Y offset value
 * @param[in] zOffset Z offset value
 * @return Predicted PMT light distribution as a vector of doubles
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
