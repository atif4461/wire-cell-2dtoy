...
/**
 * Returns a mapping of integers to their corresponding values in the library PMT.
 *
 ...
 * from a photon library file for each voxel in the detector geometry
 *
 * @return A 3D vector of pairs of int and float representing photon library data
 */
// The above comment was written by an LLM. 
...
/**
 * @brief Calculates the shifted minimum and maximum values of a vector of floats
 * @param x pointer to a vector of float values
 * @param xOffset offset value applied to the calculated minimum and maximum
 * @return pair containing the shifted minimum and maximum values
 */
// The above comment was written by an LLM. 
...
/**
 * Checks if a given pair of float values falls within a specified fiducial volume range
 * @param[in] x pair of float values representing coordinates
 ...
 * @param[in] x pair of float values to check
