...
/**
 * @brief Finds subset of indices that can be removed from the matrix without changing its rank.
 * 
 * @param toymatrix The input ToyMatrixKalman object.
 * @param toymatrix1 The input ToyMatrix object.
 * @param vec A vector to store the indices that can be removed.
 ...
 * 
 * Initializes the ToyMatrixMarkov object with the given parameters.
 * 
 * @param toycur Reference to the current ToyMatrix object.
 * @param mergecur Reference to the current MergeToyTiling object.
 * @param allmcell1 Pointer to the GeomCellSelection object.
 * @param cells Reference to the GeomCellSelection object.
...
/**
 * Brief constructor for ToyMatrixMarkov class with default parameters.
 *
 * @param toybefore reference to previous ToyMatrix object
 * @param toycur reference to current ToyMatrix object
 * @param toyafter reference to next ToyMatrix object
 * @param mergebefore reference to previous MergeToyTiling object
 * @param mergecur reference to current MergeToyTiling object
 * @param mergeafter reference to next MergeToyTiling object
 ...
 * @param penalty_ncpt noncompatible point penalty value
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 * @param allmcell1 GeomCellSelection object.
 * @param recon_t1 Reconstruction threshold 1.
 * @param recon_t2 Reconstruction threshold 2.
 * @param penalty Penalty value.
 ...
 *
 * @param toymatrix1 Pointer to the toy matrix.
 * @param allmcell1 Pointer to the geometric cell selection.
 * @param recon_t1 First reconstruction threshold.
 * @param recon_t2 Second reconstruction threshold.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Makes an initial guess for the ToyMatrixMarkov.
 * 
 * This function is used to make an initial guess for the ToyMatrixMarkov.
 * It iterates over the toy matrix, updates the prediction, and calculates 
 * various probabilities and penalties.
 * 
 * @return void
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Iterate through the ToyMatrixMarkov object, updating the Kalman filter and removing incompatible cells.
 *
