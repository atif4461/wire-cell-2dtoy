 ...
 *
 * This function prepares the tracking process by identifying and splitting merge cluster tracks.
 * It iterates over all merge cluster tracks, checks for same and different direction tracks,
 * and splits them into two new tracks if certain conditions are met.
 */
// The above comment was written by an LLM. 
...
/**
 * Forms a graph data structure from cluster tracks and merge space cells.
 */
// The above comment was written by an LLM. 
...
/**
 * Destructor to free allocated memory for cluster tracks and merge cluster tracks
 */
// The above comment was written by an LLM. 
