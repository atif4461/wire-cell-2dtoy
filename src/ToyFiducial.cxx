...
/**
 * @brief Determines whether a point is inside a polygon.
 * 
 * This function uses the ray casting algorithm to determine whether a point 
 * is inside a polygon defined by a set of vertices.
 * 
 * @param vertx A vector of x-coordinates of the polygon's vertices.
 * @param verty A vector of y-coordinates of the polygon's vertices.
 * @param testx The x-coordinate of the point to be tested.
 * @param testy The y-coordinate of the point to be tested.
 * @return An integer indicating whether the point is inside the polygon (1) or not (0).
...
/**
 * @brief Checks whether a flash is likely to be a Long Muon
 * 
 * This function takes as input a FlashTPCBundle and calculates various parameters such as 
 * cluster length, predicted PE, and measured PE. It then applies cuts on these parameters 
 * to determine whether the flash is likely to be a long muon or not.
 *
 * @param bundle The input FlashTPCBundle
 * @param cluster_length The calculated length of the cluster
 * @return An integer indicating whether the flash is likely to be a long muon (0) or not (1 or 2)
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Checks LM cuts for a given FlashTPCBundle
 * @param bundle Pointer to the FlashTPCBundle object
 * @param cluster_length Reference to the calculated cluster length
...
/**
 * @brief Checks whether a flash event passes the L/M BDT selection criteria.
 * 
 * @param bundle Pointer to the FlashTPCBundle object.
 * @param cluster_length Reference to store the calculated cluster length.
 * @return Integer indicating the result of the check.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Checks if a FlashTPCBundle is fully contained within the fiducial volume.
 * 
 * @param bundle The FlashTPCBundle to be checked.
 * @param offset_x The x-offset of the fiducial volume.
 * @param ct_point_cloud The point cloud used for signal processing checks.
 * @param old_new_cluster_map A map of old to new clusters.
 * @param fail_mode A bitfield indicating failure modes.
 * @param flag A flag indicating whether to use the original or main cluster.
 * 
 * @return True if the bundle is fully contained, false otherwise.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Checks whether a FlashTPCBundle passes the fiducial volume cut criteria.
 *
 * @param bundle The input FlashTPCBundle object.
 * @param offset_x The offset value along the x-axis.
 * @param ct_point_cloud The CT point cloud data structure.
 * @param old_new_cluster_map A map of old to new clusters.
 * @param flag A flag indicating the type of check to perform.
 * @return True if the bundle passes the fiducial volume cut criteria, false otherwise.
 
bool WCP2dToy::ToyFiducial::check_tgm(WCP::FlashTPCBundle *bundle, double offset_x, WCP::ToyCTPointCloud& ct_point_cloud,std::map<PR3DCluster*, PR3DCluster*>& old_new_cluster_map, int flag);* This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 * 
 * This function takes several parameters including clusters, points, and flags, 
 * and returns a boolean indicating whether the candidate meets the requirements.
 * 
 * @param main_cluster The cluster being processed.
 * @param wcp1 The first point of interest.
 * @param wcp2 The second point of interest.
 * @param offset_x An offset value used in calculations.
 * @param ct_point_cloud A collection of points in 3D space.
 * @param flag_2view_check A flag controlling the checking process.
...
/**
 * @brief Checks signal processing in fiducial volume
 * 
 * @param p input point
 ...
 * @return bool indicating whether signal processing is valid
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Checks if a trajectory is within the fiducial volume of the detector.
 * 
 * This function checks if a given point is inside the fiducial volume and 
 * then follows the direction vector until it exits the volume, counting 
 * the number of points that fall within dead regions along the way.
 * 
 * If more than 80% of the points are in dead regions, the function returns false,
 * indicating that the trajectory does not satisfy the selection criteria.
 * 
 * @param p The starting point of the trajectory.
 * @param dir The direction vector of the trajectory.
 * @param step The step size for following the trajectory.
 * @param offset_x An offset applied to the x-coordinate when checking the fiducial volume.
 * @return True if the trajectory satisfies the selection criteria, false otherwise.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Checks if a point is inside a dead region
 * 
 * This function determines whether a given point falls within a designated dead region.
 * It takes into account the point's coordinates and various geometric mappings to make this determination.
 * 
...
/**
 * Adds a dead region to the fiducial marked by a merge geometry cell and associated time slices.
 * 
 * @param mcell Pointer to SlimMergeGeomCell representing the affected area.
 * @param time_slices Vector of integers specifying the time range of the dead region.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
