...
/** * Constructor for ToyTiling class initializing average charge and cell count to zero.
...
/** * Adds a geometric cell to the tiling structure, associating it with specified wires and charge values.
 *
 * @param gds Reference to the Detector Geometry Data Structure containing information about the detector geometry.
 * @param cryo Identifier for the cryostat within the detector.
 * @param apa Identifier for the Anode Plane Assembly within the cryostat.
...
/** * @brief Adds a geometric cell to the tiling structure along with associated charge information.
 *
 * This method integrates a specified geometric cell into the toy tiling framework, linking it to its respective wires in the U, V, and W planes. Charge values and errors for each wire are recorded, ensuring that each wire is uniquely identified within the internal structures. If a wire has not been previously encountered, it is added to the list of known wires and its charge details are stored. Additionally, mappings between wires and cells are updated to reflect the newly added cell's associations.
 *
 ...
 * @param u_charge Charge value for the U wire.
 * @param v_charge Charge value for the V wire.
 * @param w_charge Charge value for the W wire.
 * @param u_charge_err Error associated with the charge measurement for the U wire.
 * @param v_charge_err Error associated with the charge measurement for the V wire.
 * @param w_charge_err Error associated with the charge measurement for the W wire.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
 ...
 *
 * Initializes the tiling process for a given slice and detector geometry data structure,
 * including handling wire charges, errors, and sorting wires by APA and face.
 *
 * @param slice Slice containing channel-group pairs representing hits.
 * @param gds Detector Geometry Data Structure holding geometric information.
 * @param rel_u Relative uncertainty for U plane wires.
 * @param rel_v Relative uncertainty for V plane wires.
 * @param rel_w Relative uncertainty for W plane wires.
 * @param noise_u Noise level for U plane wires.
 * @param noise_v Noise level for V plane wires.
 * @param noise_w Noise level for W plane wires.
 * @param uplane_rms RMS values for U plane wires, if available.
 * @param vplane_rms RMS values for V plane wires, if available.
 * @param wplane_rms RMS values for W plane wires, if available.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * \brief Constructor for ToyTiling class.
 *
 * Initializes the tiling process for a given slice and geometric data source,
 * setting up necessary parameters and calculating various distances and crossing points.
 *
 * \param slice Reference to the Slice object containing channel segments.
 * \param gds Reference to the GeomDataSource object providing geometric data.
 * \param rel_u Relative uncertainty for the U plane.
 * \param rel_v Relative uncertainty for the V plane.
 * \param rel_w Relative uncertainty for the W plane.
 * \param noise_u Noise level for the U plane.
 * \param noise_v Noise level for the V plane.
 * \param noise_w Noise level for the W plane.
 * \param uplane_rms Pointer to vector of RMS values for the U plane.
 * \param vplane_rms Pointer to vector of RMS values for the V plane.
 * \param wplane_rms Pointer to vector of RMS values for the W plane.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * Perform 2-plane tiling to reconstruct 3D space points using hits from at least two out of three wire planes.
 *
 * This function processes the input geometry data source to identify and tile cells formed by intersections of wires from at least two wire planes (U-V, U-W, V-W).
 * It calculates crossing points between pairs of wires, checks their proximity, and forms cells if they meet certain criteria.
 * Additionally, it updates maps associating wires with cells and vice versa, and initializes charge information for newly added wires.
 *
 * @param time Time slice identifier.
 * @param nrebin Number of rebins for time slices.
 * @param gds Geometry data source containing wire and cell information.
 * @param uplane_rms RMS noise level for the U plane wires.
 * @param vplane_rms RMS noise level for the V plane wires.
 * @param wplane_rms RMS noise level for the W plane wires.
 * @param uplane_map Mapping of wire indices to their respective ranges on the U plane.
 * @param vplane_map Mapping of wire indices to their respective ranges on the V plane.
 * @param wplane_map Mapping of wire indices to their respective ranges on the W plane.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
 ...
 * Deletes all allocated Cell objects stored in cell_all vector,
 * clears vectors containing wire information and mappings.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
WCP2dToy::ToyTiling::~ToyTiling()
{
...
/** * Retrieves the set of wires associated with a given geometric cell.
 *
 * @param cell Reference to the geometric cell for which to find associated wires.
 * @return A selection of wires associated with the specified cell, or an empty selection if the cell is not found in the map.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
 ...
 * @return A GeomCellSelection containing the cells associated with the specified wire, or an empty selection if the wire is not found in the map.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * Finds the common GeomCell associated with three distinct GeomWires across different planes.
 *
 * @param wires A selection of three GeomWires.
 * @return Pointer to the common GeomCell if found, otherwise nullptr.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * @brief Creates cells based on wire selections and geometric data source.
 *
 * This function calculates distances between wires and precomputes crossing points
 * to define cells in a 3D grid. Cells are formed where three sets of wires intersect,
 * and their centers must lie within the detector volume.
 *
 * @param tolerance A floating-point value representing the tolerance for cell creation.
 * @param gds Reference to the geometry data source containing wire information.
 * @param face An integer indicating the face of the detector.
 * @param n_tpc An integer specifying the TPC number.
 * @param temp_wire_u Reference to a selection of U-wires.
 * @param temp_wire_v Reference to a selection of V-wires.
 * @param temp_wire_w Reference to a selection of W-wires.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
