...
/**
 * @brief Constructor for ToyLightReco class
 * 
...
/**
 * Destructor for ToyLightReco class, responsible for deallocating memory 
 * allocated during object lifetime to prevent memory leaks.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Clears flash data structures and resets histograms.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Loads an event's raw data into memory for processing.
 * 
 * @param eve_num The event number of the data to be loaded.
 * @param tMin The minimum time threshold for loading data.
 * @param tMax The maximum time threshold for loading data.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Updates the PMT mapping by swapping channels for all flashes. 
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Sorts flashes into separate sets to remove duplicates.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Process waveforms for a given time range
 *
 * This function processes waveforms within a specified time range, applying corrections and filters as necessary.
 * It takes two parameters, tMin and tMax, representing the minimum and maximum times for processing.
 *
 * @param tMin Minimum time for processing
 * @param tMax Maximum time for processing
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 *
 * @param high Whether it's a high gain channel.
 * @param beam Whether it's a beam-off run.
 * @param wf Array of waveforms.
 * @param chan Vector of channel numbers corresponding to waveforms.
 * @param timestamp Vector of timestamps corresponding to waveforms.
 * @return Map of PMT discs, keyed by channel number.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Generates beam pairs from high and low pmt map sets
 * 
 * @param high High pmt map set
 * @param low Low pmt map set
 * @return Map of beam pairs
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Makes cosmic pairs from high and low pmt map sets.
 *
 * This function takes two pmt map sets as input, one for high energy events and one for low energy events,
 * and returns a pair of pmt map sets where corresponding high and low energy events are paired together.
 *
 * The pairing is done based on the timestamp difference between the events, with a window of 20 ticks.
 *
 * If a high energy event does not have a matching low energy event within the time window, it is paired with itself.
 *
 * @param high High energy pmt map set
 * @param low Low energy pmt map set
 * @return Pair of pmt map sets with paired high and low energy events
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Merges beam data from two PMT maps into one.
 * 
 * This function takes a pair of PMT maps as input, merges them, and returns the resulting PMT map.
 * It checks for saturated channels and replaces their waveforms with those from the second PMT map.
 * 
 * @param beam Pair of PMT maps to be merged.
 * @return The merged PMT map.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Merges cosmic map sets into a single set
 * @param cosmic Pair of PMT map sets to be merged
 * @return Merged PMT map set
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 *
 * @param wfm Waveform data as a vector of shorts.
 * @return Saturation tick data.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Replaces saturated bins with corresponding values from a lower gain channel.
 *
 * This function takes two vectors of shorts representing high and low gain channels,
 * as well as a saturation tick object containing information about saturated bins.
 * It replaces the saturated bins in the high gain channel with the corresponding values
 * from the low gain channel and returns the modified high gain channel vector.
 *
 * @param high Vector of shorts representing the high gain channel.
 * @param low Vector of shorts representing the low gain channel.
 * @param st Saturation tick object containing information about saturated bins.
 * @return The modified high gain channel vector with saturated bins replaced.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Dumps PMT vector into FOP data structures
 * 
 * This function takes two parameters, beam and cosmic, which are of type pmtMap and pmtMapSet respectively.
 * It iterates over the beam map, extracts channel and timestamp information, and stores them in fop_femch and fop_timestamp vectors.
 * For each entry in the beam map, it creates a new TH1S histogram with bin size equal to the size of the wfm vector, 
 * and sets the bin content according to the corresponding value in the wfm vector.
 * The same process is repeated for the cosmic map set, but this time iterating over each individual cosmic map.
 * 
 * @param beam A map of PMT information
 * @param cosmic A set of maps of cosmic PMT information
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Calculates the baseline of a histogram within a specified range.
 *
 * This function finds the baseline of a histogram by creating a new histogram
 * with a limited range, filling it with bin contents within a certain range,
 * and returning the center of the bin with the maximum value.
 *
 * @param hist Input histogram
 * @param nbin Not used in this implementation
...
/**
 * Calculates the mean and RMS of a histogram.
 *
 * This function takes a histogram and the number of bins as input, 
 * calculates the mean and RMS, and returns them as a pair of doubles.
 *
 * @param hist The input histogram.
 * @param nbin The number of bins in the histogram.
 * @return A pair containing the calculated mean and RMS.* This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Returns the scaling factor for a given opdet number.
 *
 * This function takes an integer opdet as input and returns the corresponding
 * scaling factor as a float value. The function uses a series of if statements
 * to determine the correct scaling factor based on the input opdet value.
 *
 * @param opdet The opdet number for which the scaling factor is required.
 * @return The scaling factor for the given opdet number.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
