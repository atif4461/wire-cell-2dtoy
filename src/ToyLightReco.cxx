...
/**
 * Clears all stored flash data, deleting dynamically allocated memory,
 * resets histograms and clears various containers to prepare for new data.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
 ...
 * @param tMin Minimum time for loading event data.
 * @param tMax Maximum time for loading event data.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
 ...
 *
 * This function processes the waveforms for a specified time range, performing 
 * baseline correction, deconvolution, and flash identification.
 *
 * @param tMin Minimum time of the range.
 * @param tMax Maximum time of the range.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
 ...
 * It processes the data and returns a map of pmt discs.
 *
 ...
 * @param chan Channel numbers corresponding to the waveform data.
 * @param timestamp Timestamps corresponding to the waveform data.
...
/**
 * Creates pairs of PMTs between high and low sets based on timestamp proximity.
 *
 * @param high High set of PMTs.
 * @param low Low set of PMTs.
 * @return Pairs of PMTs with matching timestamps within a specified window.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
 ...
 * @param wfm Waveform data.
 * @return Vector of pairs containing start and end indices of saturation regions.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
 ...
 * @param st A structure containing saturation tick information.
