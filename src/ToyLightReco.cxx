 ...
 *
 * @param root_file Root file path for data retrieval.
 * @param imagingoutput Flag indicating whether imaging output is required.
 * @param datatier Data tier level for processing.
...
/**
 * Destructor for the ToyLightReco class, responsible for deallocating memory 
 * allocated for various objects and arrays to prevent memory leaks.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * Clears all stored flash data and resets associated histograms.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * @brief Loads raw event data.
 *
 * This function loads raw event data from a specified event number within a given time range.
 * It performs several operations including setting up the event, handling zero op gains,
 * creating pmt containers, merging beams, and processing waveforms.
 *
 * @param eve_num Event number to load.
 * @param tMin Minimum time for the event.
 * @param tMax Maximum time for the event.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * Updates the PMT map by iterating over flashes and swapping channels.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
 ...
 *
 * This function processes waveforms within a specified time range, performing 
 * corrections, deconvolutions, and flash identifications.
 *
 * @param tMin Minimum time value for processing.
 * @param tMax Maximum time value for processing.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * @brief Creates a pmt container based on waveform data.
 *
 * This function takes in several parameters including whether the data is from a high gain channel,
 * whether it's from a beam run, the waveform data itself, channel numbers, and timestamps.
 * It processes the data and returns a map of pmt discs, where each disc represents a single
 * photomultiplier tube signal.
 *
 * @param high Whether the data is from a high gain channel.
 * @param beam Whether the data is from a beam run.
 * @param wf The waveform data.
 * @param chan The channel numbers corresponding to the waveform data.
 * @param timestamp The timestamps corresponding to the waveform data.
 * @return A map of pmt discs.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
 ...
 *
 * @param[in] high High PMT map set.
 * @param[in] low Low PMT map set.
 * @return Map of PMT pairs.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
 ...
 *
 * This function takes two pmtMapSets, one for high gain and one for low gain,
 * and returns a pmtMapSetPair where each pair consists of a hit from the
 * high gain channel and a corresponding hit from the low gain channel.
 *
 * The pairing is done based on the timestamp difference between the hits,
 * with a maximum allowed difference defined by the tickWindow and tick parameters.
 *
 * If a hit in the high gain channel does not have a matching hit in the low
 * gain channel within the allowed time window, it is paired with itself.
 *
 * @param high The pmtMapSet for the high gain channel.
 * @param low The pmtMapSet for the low gain channel.
 * @return A pmtMapSetPair containing the paired hits.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * Merges beam data into a single pmt map.
 *
 * @param beam Pair of PMT maps to merge
 * @return Merged PMT map
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * Merges cosmic pairs into a single set of PMT maps.
 *
 * @param cosmic Pair of PMT maps to merge
 * @return Merged set of PMT maps
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
 ...
 *
 * This function iterates through a given waveform and identifies intervals where the signal exceeds a predefined saturation threshold.
 *
 * @param wfm Waveform data represented as a vector of shorts.
 * @return A collection of saturation tick intervals.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * Replaces saturated bins in the high vector with corresponding values from the low vector.
 *
 * @param high The vector containing high values that may need replacement.
 * @param low The vector containing low values used for replacement.
 * @param st A structure containing saturation ticks that define which bins to replace.
 * @return The modified high vector with replaced saturated bins.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * Dumps PMT vector data into histograms.
 *
 * @param beam Beam map containing channel and timestamp information.
 * @param cosmic Cosmic map set containing channel and timestamp information.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * Returns the scaling factor for a given opdet identifier.
 *
 * @param opdet the opdet identifier
