...
/**
 * @class WCP2dToy
 * @brief A class containing methods for 2D toy clustering.
   * @fn Clustering_isolated
 * @brief Performs isolated clustering on a set of 3D clusters.
 * @param live_clusters A selection of 3D clusters to be clustered.
 * @param cluster_length_map A map of cluster lengths.
 * @return A map of clustered clusters with their corresponding distances.
