...
/** * Constructor for LowmemTiling class.
 *
 ...
 *
 * @param time_slice The time slice identifier.
 * @param gds Reference to the geometry data source containing wire plane information.
 * @param holder Reference to the WCPHolder object holding additional data structures.
...
/** * Constructor for LowmemTiling class.
 *
 * Initializes the LowmemTiling object with specified parameters and retrieves wire selections for U, V, and W planes.
 *
 * @param time_slice The time slice number for the current processing step.
 * @param nrebin Number of bins for rebinning operations.
 * @param gds Reference to the geometry data source containing wire information.
 * @param holder Reference to the WCPHolder object managing data storage and retrieval.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * @brief Finds L1SP wires within specified index range in the Y plane and returns associated V plane wires.
 *
 * Iterates over cells containing two good wires, checks if any Y plane wire indices fall within the range [2336, 2463].
 * If a match is found, adds all associated V plane wires to the result set.
 *
 * @return Selection of GeomWire objects representing the V plane wires meeting the criteria.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * @brief Divides wires into smaller segments based on specified limits and conditions.
 *
 * This method processes parent wires and divides them into smaller wire segments under certain constraints.
 * It ensures that the resulting wire segments meet minimum length requirements and does not exceed a maximum limit.
 * The division process involves sorting wires, identifying valid segment endpoints, creating new wire segments,
 * updating related mappings, and removing obsolete wire segments.
 *
 * @param wire_limit Maximum allowed number of wire segments.
 * @param min_wire Minimum required length for a wire segment.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * @brief Merges wires based on geometric criteria within cells.
 *
 * Iterates over parent wire maps and merges wires associated with each parent wire if they meet certain conditions.
 * After merging, calculates the charge of merged wires and orders wires within each cell.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * Calculates the merged wire charges for each group of wires in the map,
 * considering both good and bad wires. Good wires' charges are summed up,
 * and their errors are combined quadratically. Bad wires are assigned a
 * charge of 0 and an error of -1. Relative uncertainties are added based on
 * the wire plane type.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
 ...
 *
 * @param allwire Reference to a GeomWireSelection containing individual wires to be potentially merged.
 * @return Integer representing the difference between the initial size of allwire and the final size after merging.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
 ...
 *
 * This method updates the internal mappings to substitute the specified old wire with the new wire.
 * It ensures consistency across multiple data structures including wire type map, wire-wire map,
 * and cell-wire map.
 *
...
/** * @brief Removes a wire clear from internal mappings and deletes the wire object.
 *
 * This method updates several internal maps related to wire geometry and charge information,
 * removing entries associated with the specified wire. After updating the maps, the wire object itself is deleted.
 *
...
/** * @brief Removes a wire from various internal mappings within the LowmemTiling class.
 *
 * This method handles the removal of a specified wire from multiple associative containers,
 * including cell-wire mappings, parent-child wire relationships, charge-related maps, and wire type mappings.
 * If the wire has associated cells, the operation fails and returns false; otherwise, the wire is safely removed
 * from all mappings and deleted.
 *
 * @param wire Pointer to the MergeGeomWire object representing the wire to be removed.
 * @return True if the wire was successfully removed, false if the wire still has associated cells.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * Erases a specified geometry cell from various internal collections and maps within the LowmemTiling class.
 *
 * This method performs several operations:
 * - Removes the cell from lists `three_good_wire_cells`, `two_good_wire_cells`, and `one_good_wire_cells`.
 * - Deletes references to the cell in `cell_wires_map` and updates `wire_cells_map` accordingly.
 * - If a wire no longer connects to any cells, it is removed from consideration.
 *
...
/** * Removes a geometry cell from the internal mappings and deletes the cell object.
 *
 * This method updates the `cell_wires_map` and `wire_cells_map` to reflect the removal of the specified cell.
 * If a wire becomes disconnected from all cells after the removal, it is also removed from the system.
 *
...
/** * @brief Tests a point within a specified region defined by U and V coordinates and checks its distance to Y wires.
 *
 * This method calculates crossing points around a given point in a grid defined by U and V pitches.
 * It then evaluates whether these points fall within a specified range along the Y axis (between bmin_w and bmax_w).
 * If any valid points are found, they are added to the PointVector pcell.
 *
 * @param pcell Reference to a vector where valid points will be stored.
 * @param dis_u U coordinate of the center point.
 * @param dis_v V coordinate of the center point.
 * @param bmin_w Minimum allowed distance to Y wires.
 * @param bmax_w Maximum allowed distance to Y wires.
 * @param u_pitch Pitch between U wires.
 * @param v_pitch Pitch between V wires.
 * @param dis1 Output parameter storing the distance of the central point to the nearest Y wire.
 * @return True if any valid points are found within the specified range; otherwise, false.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * @brief Tests crossing points between wires in specified planes and adds valid intersection points to a point vector.
 *
 * This method calculates crossing points between wires in two perpendicular planes (one specified and another determined based on input).
 * It iterates over a range defined by limits and steps, checking for intersections at calculated positions.
 * Valid intersection points meeting distance criteria are added to the output point vector.
 *
 * @param[out] pcell Point vector to store valid intersection points.
 * @param[in] dis Distance parameter for crossing point calculation.
 * @param[in] plane Plane type for which crossings are tested (either U-wire or V-wire).
 * @param[in] low_limit Lower limit for position iteration.
 * @param[in] high_limit Upper limit for position iteration.
 * @param[in] pitch Pitch value for one plane.
 * @param[in] pitch1 Pitch value for the other plane.
 * @param[in] w_pitch Wire pitch value.
 * @param[in] wire1 Pointer to the first geometry wire.
 * @param[in] wire2 Pointer to the second geometry wire.
 * @param[in] dir Direction of iteration (1 for increasing, -1 for decreasing).
 * @param[in] bmin_w Minimum boundary for valid intersection distances.
 * @param[in] bmax_w Maximum boundary for valid intersection distances.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * Prints the sizes of several internal maps related to wire types, cells,
 * wires, physical wires, and the mapping between physical wires and wires.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * Re-establishes mappings between geometry cells and wires.
 *
 * This function reconstructs several mapping structures:
 * - Maps from cells to their associated up-wires, VP-wires, and WP-wires.
 * - Maps from wires back to their respective cells.
 * - Maps from child wires to their parent wires.
 * - Maps from parent wires to their associated child wires.
 *
 * It first clears existing mappings and then repopulates them based on current cell configurations.
...
/** * Perform local deghosting on geometry cells.
 *
 * This method processes geometry cells to remove ghost cells that do not meet certain criteria,
 * focusing on cells with either two or three active wire planes. It calculates scores for each wire
 * based on their presence in multiple cells and determines whether cells should be removed based
 * on adjacency and scoring thresholds.
 *
 * @param good_mcells A set of geometry cells considered good, used to check adjacency.
 * @param map_mcell_charge A map associating each geometry cell with its charge value.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
 ...
 *
 * This function processes sets of geometric cells to remove ghost cells,
 * which are cells that do not meet certain criteria related to adjacency
 * and wire usage. It identifies cells that can be removed without affecting
 * the integrity of the overall structure and updates the input sets accordingly.
 *
 * @param potential_good_mcells Set of potentially good merge geometry cells.
 * @param good_mcells Set of confirmed good merge geometry cells.
 * @param flag_del Flag indicating whether to delete identified cells immediately.
 * @return Selection of geometry cells that were deemed unnecessary and removed.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * Resets the internal state of the LowmemTiling object by clearing all vectors and maps related to wire cells and charges.
 * This method ensures that all dynamically allocated objects within the member containers are properly released,
 * preventing memory leaks. It clears vectors containing information about fired wires, bad wires, and good wire cells,
 * as well as maps associating wires with charge values and types.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
 ...
 *
 * This method processes the input maps containing charged wires in U, V, and W views,
 * along with their associated charges and errors. It forms fired merge wires with charge
 * and then iterates over combinations of fired wires from U, V, and W views to create
 * slim merged geometry cells. Each cell is set with the current time slice and added
 * to the holder if successfully created.
 *
 * @param u_time_chs Map of time slices to sets of channel indices with charge in the U view.
 * @param v_time_chs Map of time slices to sets of channel indices with charge in the V view.
 * @param w_time_chs Map of time slices to sets of channel indices with charge in the W view.
 * @param time_ch_charge_map Map of pairs (time slice, channel index) to charge values.
 * @param time_ch_charge_err_map Map of pairs (time slice, channel index) to charge error values.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
 ...
 *
 * This method processes input maps containing time channels for U, V, and W planes,
 * forms fired merge wires, and then iterates over combinations of these wires to create
 * slim merge geometry cells. Each valid cell is set with a specified time slice and added
 * to a holder structure.
 *
 * @param u_time_chs Map of time slices to sets of channel indices for the U plane.
 * @param v_time_chs Map of time slices to sets of channel indices for the V plane.
 * @param w_time_chs Map of time slices to sets of channel indices for the W plane.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * Initializes good cells based on fired and error slices.
 *
 * Forms groups of good wires and creates slim merge geometry cells
 * for combinations of U, V, and W wires. Populates various mapping structures
 * between cells and wires, including mappings for parent wires and wire types.
 *
 * @param slice Slice containing information about fired wires.
 * @param slice_err Slice containing error information.
 * @param uplane_rms RMS values for U plane.
 * @param vplane_rms RMS values for V plane.
 * @param wplane_rms RMS values for W plane.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * @brief Retrieve the centers of all cells.
 *
 * This method iterates over the mapping of cells to wires,
 * calculates the crossing point between the middle U-wire and V-wire
 * of each cell, and returns a vector containing the center coordinates
 * of all cells.
 *
 * @return A PointVector containing the center coordinates of all cells.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
 ...
 *
 * Iterates over the wire_cells_map, checks if the wire type is marked as good,
 * and adds the corresponding MergeGeomWire objects to the wires vector.
 *
...
/** * @brief Retrieves all bad wires from the wire cell map.
 *
 * Iterates over the wire_cells_map and collects wires marked as bad
 * in the wire_type_map.
 *
...
/** * \brief Creates good wire cells by identifying fired wires across multiple wire planes and handling leftover wires.
 *
 * This method processes wire cells identified in previous steps (`three_good_wire_cells` and `two_good_wire_cells`)
 * to identify all fired wires. It then handles any leftover wires that were not included in the initial set of good cells,
 * creating new cells as necessary. The method ensures that cells are properly mapped to their constituent wires and vice versa,
 * maintaining relationships between parent wires and merged wires. Finally, it checks for overlaps with previously identified
 * good cells and adds those without overlaps to the list of one-good-wire-cells.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * Creates individual geometric cells from merged geometry cells.
 *
 * Iterates over a map of cell-wire associations, creating single cells
 * from each SlimMergeGeomCell entry. The centers of these cells are added
 * to a list of points.
 *
 * @return A collection of individual geometric cells.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * @brief Creates single geometry cells from a merged geometry cell.
 *
 * This function generates individual geometric cells based on the intersections
 * of wires in the U, V, and W planes of a SlimMergeGeomCell. It calculates
 * crossing points between pairs of wires and determines valid cells based on
 * specified tolerances and conditions.
 *
 * @param mcell Pointer to the SlimMergeGeomCell containing merged wire information.
 * @return GeomCellSelection A collection of generated geometric cells.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
 ...
 *
 * This method examines the chirp maps for the u-plane, v-plane, and w-plane to detect any inconsistencies
 * related to time slices. If discrepancies are found, it triggers regeneration of bad cells. Otherwise,
 * it copies the existing bad cells and wires from the provided tiling object.
 *
 * @param tiling Pointer to the LowmemTiling object containing the current tiling information.
...
/** * Initializes bad cells in the low-memory tiling process.
 *
 * Forms groups of bad wires across multiple planes and creates special bad wire cells.
 *
 * @param uplane_map Chirp map representing the U plane.
 * @param vplane_map Chirp map representing the V plane.
 * @param wplane_map Chirp map representing the W plane.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * \brief Forms two-bad-wire cells by identifying crossing points between pairs of wires in different planes.
 *
 * This method iterates over pairs of wires in the U and V planes, then U and W planes, and finally W and V planes,
 * to find crossing points. If valid crossing points are found, they are used to define boundaries of geometric cells.
 * Cells formed with fewer than three boundary points are discarded. Each identified cell includes wires from the
 * respective planes and is added to the list of two-bad-wire cells.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * Forms fired wires by merging adjacent wires with associated charge information for specified time slices.
 *
 * Iterates over channels in each plane (U, V, W) for a given time slice, checks if they contain charge,
 * assigns charge values, and merges consecutive wires into MergeGeomWire objects. These merged wires are then added
 * to respective lists for each plane.
 *
 * @param u_time_chs Map containing sets of channel indices for each time slice in the U plane.
 * @param v_time_chs Map containing sets of channel indices for each time slice in the V plane.
 * @param w_time_chs Map containing sets of channel indices for each time slice in the W plane.
 * @param time_ch_charge_map Map mapping pairs of time slice and channel index to charge values.
 * @param time_ch_charge_err_map Map mapping pairs of time slice and channel index to error values of charges.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * @brief Forms merged wires from fired channels in specified time slices for U, V, and W planes.
 *
 * This method processes the set of fired channels for each plane (U, V, W) at a given time slice,
 * creating instances of `MergeGeomWire` for contiguous sequences of active wires. These instances
 * are then stored in respective vectors (`fired_wire_u`, `fired_wire_v`, `fired_wire_w`) for further
 * processing.
 *
 * @param u_time_chs Map containing sets of fired channel numbers indexed by time slice for the U plane.
 * @param v_time_chs Map containing sets of fired channel numbers indexed by time slice for the V plane.
 * @param w_time_chs Map containing sets of fired channel numbers indexed by time slice for the W plane.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * @brief Forms fired wires by merging adjacent wires in specified slices for each wire plane.
 *
 * This method processes charges associated with wires in the provided slices,
 * grouping adjacent wires together based on their indices within each wire plane.
 * The resulting merged wires are stored in separate vectors corresponding to the U, V, and W wire planes.
 *
 * @param slice Slice containing charge information for wires.
 * @param slice_err Slice containing error information for charges associated with wires.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * @brief Forms bad merge wires for specified planes within a given time slice.
 *
 * Iterates over the wire maps for the U, V, and W planes to identify and group wires
 * that fall within the current time slice. These wires are then added to respective
 * lists of bad wires for each plane.
 *
 * @param uplane_map Map containing wire information for the U plane.
 * @param vplane_map Map containing wire information for the V plane.
 * @param wplane_map Map containing wire information for the W plane.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * @brief Retrieve the set of wires associated with a given geometric cell.
 *
 * This method returns a collection of wires that correspond to the specified geometric cell.
 *
 * @param cell The geometric cell for which to retrieve the associated wires.
 * @return A selection of wires associated with the input cell.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
...
/** * @brief Retrieve the geometric cell selection associated with a given wire.
 *
 * This method returns a collection of geometric cells that are related to the specified wire.
 *
 * @param wire Reference to the wire for which the geometric cell selection is requested.
 * @return WCP::GeomCellSelection Collection of geometric cells associated with the input wire.
 * This comment was generated by Qwen/Qwen2.5-Coder-32B-Instruct:None at temperature 0.2.
*/ 
