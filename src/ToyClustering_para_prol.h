/**
 * @brief Clustering algorithm for merging clusters in 3D space.
 *
 * This function takes in a set of live clusters, a map of cluster lengths,
 * and a set of connected dead clusters. It calculates the length of each
 * live cluster, identifies pairs of clusters to be merged based on their
 * lengths and a given cut-off value, and merges the identified clusters.
 *
 * The resulting merged clusters are added to the live cluster list,
 * and the original clusters are removed. The function also updates
 * the cluster length map and the set of connected dead clusters accordingly.
 *
 * @param live_clusters The set of live clusters to be processed.
 * @param cluster_length_map A map of cluster lengths.
 * @param cluster_connected_dead A set of connected dead clusters.
 * @param length_cut The cut-off value for merging clusters.
...
/**
 * @class WCP2dToy
 * @brief A class providing methods for clustering and merging of 2D toy data.
  
 * @fn bool WCP2dToy::Clustering_2nd_round(WCP::PR3DCluster *cluster1, WCP::PR3DCluster *cluster2, double length_1, double length_2, double length_cut)
 * @brief Performs second round clustering of two input clusters.
 *
 * @param cluster1 The first input cluster.
 * @param cluster2 The second input cluster.
 * @param length_1 The length of the first cluster.
 * @param length_2 The length of the second cluster.
 * @param length_cut The cut-off length for clustering.
 *
