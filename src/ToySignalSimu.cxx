 ...
 * @param[in] time_offset_uv Time offset for u-view
 * @param[in] time_offset_uw Time offset for w-view
 ...
 * @param[in] gds         Detector geometry data structure object
 * @param[in] conf        Electronics configuration object
 * @param[in] nframes_total Total number of frames
 ...
 * @param conf Electronics configuration object reference
 * @param nframes_total Total number of frames
 ...
 *
 * Creates a new file if it does not exist, otherwise recreates it.
 * Writes histograms hu1, hv1, and hw1 to the file for each wire index.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * @brief Jumps to a specific frame number in the simulation.
 *
...
/**
 * Destructor for ToySignalSimuFDS class, responsible for deallocating memory 
 * allocated during simulation, depending on the type of simulation performed * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
