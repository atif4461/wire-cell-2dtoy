 ...
 * @param uplane_map A map of U-plane chirps.
 * @param vplane_map A map of V-plane chirps.
 * @param wplane_map A map of W-plane chirps.
 * @param gds The geometry data source.
 * @param flag_1plane A flag indicating whether to consider one plane or all planes.
 * @param flag_all A flag indicating whether to consider all times or a specific time range.
