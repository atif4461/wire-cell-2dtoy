...
/**
 * @brief Jumps to a specific frame number in the signal pre-FDS process.
 *
 * This function fills the frame data, performs operations on matrices,
 * and updates the frame index accordingly.
 *
