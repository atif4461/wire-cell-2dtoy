...
/**
 * @class WCP2dToy
 * @brief This class contains methods for clustering analysis in 2D toy data.
 ...
 * @brief Checks whether two clusters should be merged based on various conditions.
 *
 ...
 * @param num_dead_try Number of attempts to merge the clusters.
 ...
 * @param length_cut The cut-off distance for merging clusters.
