...
/**
 * Examines flash TPC bundles and returns a new selection of bundles after processing.
 *
 * @param bundles Input flash TPC bundle selection
 * @param ct_point_cloud Point cloud data for examination
 * @return New flash TPC bundle selection after examination
...
/**
 * Examines a flash TPC bundle and separates it into multiple clusters if necessary.
 *
 ...
 * @param ct_point_cloud The point cloud associated with the bundle
