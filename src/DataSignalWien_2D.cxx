 ...
 * @param[in] umap      Chirp map for u dimension.
 * @param[in] vmap      Chirp map for v dimension.
 * @param[in] wmap      Chirp map for w dimension.
...
/**
 * Saves the data signal Wien 2D FDS to a file.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * @brief Jumps to a specific frame number in the DataSignalWien2DFDS object.
 *
