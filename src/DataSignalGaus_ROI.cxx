...
/**
 * Returns the index of the filled frame data for a given frame number
 * @param frame_number The number of the frame to be processed
 * @return The index of the filled frame data
 */
// The above comment was written by an LLM. 
