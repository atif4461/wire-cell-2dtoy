 ...
 * @param fds input DataSignalWienROIFDS object 
...
/**
 * Returns the current frame number after filling the frame data.
 *
 * @param frame_number The index of the frame to be filled.
