...
/**
 * @brief Constructor for DataSignalGausROIFDS class
 * @param fds reference to DataSignalWienROIFDS object
...
/**
 * @brief Jumps to the specified frame number in the data signal generator
 * 
