 ...
 * number of bins per frame, total number of frames, time offsets for UV and UW,
 * and an overall time offset.
 *
...
/**
 * @brief Saves the signal data to a ROOT file
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Jumps to the specified frame number in the data signal Gaus FDS.
 *
 * This function clears the current frame, jumps to the specified frame number,
 * and fills the frame data with the corresponding traces from the FFTs of the signals.
 *
 * @param frame_number The index of the frame to jump to.
 ...
 * Destroys dynamically allocated memory to prevent memory leaks
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
