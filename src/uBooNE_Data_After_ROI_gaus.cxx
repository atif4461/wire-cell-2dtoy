...
/**
 * Constructor for uBooNEDataAfterROI_Gaus class
 * Initializes object with frame data and region of interest information
 * @param frame_data pointer to 2D deconvolution FD data
 * @param frame_rois pointer to after ROI data
 * @param gds reference to geometric data source
...
/**
 * @brief Jumps to a specific frame number and performs ROI Gaussian data processing.
 *
