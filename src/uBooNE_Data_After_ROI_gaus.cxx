...
/**
 * @brief Constructor for uBooNEDataAfterROI_Gaus class
 * 
 * @param frame_data Pointer to uBooNEData2DDeconvolutionFDS object
 * @param frame_rois Pointer to uBooNEDataAfterROI object
...
/**
 * @brief Jumps to a specific frame number in the data and performs processing.
 * 
