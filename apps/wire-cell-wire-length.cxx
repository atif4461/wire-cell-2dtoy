...
/** * @brief Main entry point for the Wire Cell UBOONE geometry processing tool.
 *
 * Parses command-line arguments to configure reconstruction settings,
 * initializes geometric data source, and outputs wire information.
 *
 * Command-line options include paths to geometry files, event numbers,
 * and flags for enabling two-plane reconstruction and saving output files.
