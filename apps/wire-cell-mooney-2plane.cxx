...
/** * @brief Main function to execute the LArTPC signal simulation and reconstruction pipeline.
 *
 * Parses command-line arguments to configure simulation parameters, initializes geometry and data sources,
 * performs signal simulation across multiple stages including raw waveform simulation, deconvolution,
 * and charge estimation, processes reconstructed slices, applies connectivity algorithms for charge solving,
