 ...
 *
 * This function initializes parameters, processes command-line arguments,
 * loads geometry data, reads simulation data, performs signal simulations,
 * applies various filters, slices the signals, merges cells, solves charges,
 * and saves the results to output files.
 *
 * Command-line options include paths to geometry and simulation data files,
 * event number, and flags for enabling/disabling certain features such as
 * two-plane processing and saving files.
