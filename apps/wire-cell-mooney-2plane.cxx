...
/** * @brief Main entry point for the wire-cell-mooney-2plane application.
 *
 * Parses command-line arguments to configure various parameters such as geometry files,
 * event numbers, and flags for enabling/disabling certain features. Initializes geometric
 * data sources, reads ROOT files containing simulated events, performs signal simulations,
 * applies filters, and reconstructs showers. Saves the results to output ROOT files.
 *
 * Command-line options include:
 * - Path to ChannelWireGeometry.txt
 * - Path to celltree.root
 * - Event number to process
 * - Flags for enabling/disabling two-plane mode (-t[0,1])
 * - Flags for saving files (-s[0,1,2])
