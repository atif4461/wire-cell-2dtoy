 ...
 *
 * This function initializes necessary parameters, loads geometry and event data,
 * performs signal simulations, applies deconvolutions, slices the signals,
 * merges slices, solves matrices, and saves the reconstructed shower data.
 *
 * @param argc Number of command-line arguments.
 * @param argv Command-line argument array containing paths to input files and event number.
