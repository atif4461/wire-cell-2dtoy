...
/** * @brief Main entry point of the application that demonstrates Gaussian Process regression.
 *
 * Initializes a Gaussian Process model, sets parameters, loads measurement data,
 * calculates conditional mean and variance over a specified range, and visualizes
 * both measurements and predictions using ROOT graphics.
