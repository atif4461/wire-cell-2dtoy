...
/** * @brief Main function to demonstrate Gaussian Process regression.
 *
 * Initializes a Gaussian Process object, sets its parameters,
 * loads measurement data, calculates conditional mean and variance,
 * and visualizes the results using ROOT graphics.
 *
 * @param argc Number of command-line arguments.
 * @param argv Array of command-line argument strings.
  * @brief Sets the parameters for the Gaussian Process model.
 *
 * @param pars Vector containing the parameters to be set.
  * @brief Sets the measurement data for the Gaussian Process model.
 *
 * @param data Vector of tuples representing the measurement data.
  * @brief Calculates the conditional mean of the Gaussian Process model.
 *
 * @param vec_x Input vector of x-values for prediction.
 * @return Vector containing the predicted y-values.
  * @brief Calculates the conditional variance of the Gaussian Process model.
 *
 * @param vec_x Input vector of x-values for prediction.
 * @return Vector containing the predicted variances.
