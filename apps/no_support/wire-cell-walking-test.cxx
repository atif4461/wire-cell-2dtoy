...
/** * @brief Main entry point for the wire-cell-cluster application.
 *
 * Parses command-line arguments, initializes geometry data source,
 * reads ROOT file containing shower data, processes specified cluster,
 * performs clustering operations including merging space cells,
 * crawling through clusters, and performing toy walking.
 *
