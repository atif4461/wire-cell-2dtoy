...
/** * @brief Main function to process shower data and perform clustering operations.
 *
 * This function initializes necessary parameters, reads data from ROOT files,
 * processes the data to extract space cells belonging to specified clusters,
 * performs merging and crawling operations on the extracted cells, and outputs
 * relevant information about the processed clusters.
 *
 * @param argc Number of command-line arguments passed to the program.
 * @param argv Array of strings representing the command-line arguments.
 * @return Integer indicating the exit status of the program (0 for successful execution).
