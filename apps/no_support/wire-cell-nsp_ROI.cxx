...
<< endl;
 * @brief Open root file and retrieve trees and histograms
 *
 * @param argv Command line argument array
 ...
 * @brief Create data source objects
 ...
 * @brief Retrieve chirp maps and noisy channels
...
Trun->GetEntry(0);
 * @brief Create ROI and after ROI data sources
...
roi_fds.jump(0);
 * @brief Retrieve wire selections
 ...
 * @brief Get total time bin
 
int  total_time_bin = hu_decon->GetNbinsY();
 * @brief Create output file and histograms
 ...
 * @brief Loop through traces and fill histograms
