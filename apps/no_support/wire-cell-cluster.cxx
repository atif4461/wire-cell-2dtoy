 ...
 * @brief Set up TPC parameters.
 *
 * @param mp TPC params object reference.
 * @param gds Geometry data source object.
 * @param nrebin Rebin value.
 * @param unit_dis Unit distance value.
 * @return None.
 
void setup_tpc_params(TPCParams& mp, const GeomDataSource& gds, int nrebin, float unit_dis)
 * @brief Load mcell data.
 *
 * @param file TFile object pointer.
 * @param mcells MCell selection object reference.
 * @return None.
 
void load_mcell(TFile* file, GeomCellSelection& mcells)
 * @brief Create point cloud and mcell to cluster mapping.
 *
 * @param live_clusters Live cluster selection object reference.
 * @param global_point_cloud Global point cloud object reference.
 * @return None.
 
void create_point_cloud_and_mapping(PR3DClusterSelection& live_clusters, DynamicToyPointCloud& global_point_cloud)
 * @brief Perform clustering and trajectory fitting.
 *
 * @param live_clusters Live cluster selection object reference.
 * @return None.
 
void perform_clustering_and_trajectory_fitting(PR3DClusterSelection& live_clusters)
 * @brief Save results to output file.
 *
 * @param live_clusters Live cluster selection object reference.
 * @param file1 Output file object pointer.
 * @return None.
 
void save_results(const PR3DClusterSelection& live_clusters, TFile* file1)
