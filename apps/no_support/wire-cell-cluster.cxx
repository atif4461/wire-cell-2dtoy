...
Here are the Doxygen-style comments for each function:

``` * @brief Main program entry point.
 *
 * This is the main function where the program starts execution.
 * It checks command line arguments and initializes variables.
 *
 ...
 * @brief Disables ROOT directory creation.
...
//...
 * @brief Loads mcell from file.
 *
 * @param file Input file.
 * @return MCell object.
 
TTree *TC = (TTree*)file->Get("TC");
 * @brief Loads TDC from file.
 *
 * @param file Input file.
 * @return TDC object.
 
TTree *TDC = (TTree*)file->Get("TDC");
 * @brief Forms boundaries for bad cells.
 *
 * @param gds Geometry data source.
 * @param dead_clusters Dead clusters.
 
void WCP2dToy::calc_boundary_points_dead(GeomDataSource &gds, PR3DCluster &dead_clusters)
 * @brief Forms sampling points for normal cells.
 *
 * @param gds Geometry data source.
 * @param live_clusters Live clusters.
 * @param nrabin Rebin number.
 * @param frame_length Frame length.
 * @param unit_dis Unit distance.
 
void WCP2dToy::calc_sampling_points(GeomDataSource &gds, PR3DCluster &live_clusters, int nrabin, int frame_length, double unit_dis)
 * @brief Clusters to jump gap in cosmics.
 *
 * @param live_clusters Live clusters.
 * @param dead_clusters Dead clusters.
 * @param dead_u_index Dead U index.
 * @param dead_v_index Dead V index.
 * @param dead_w_index Dead W index.
 * @param global_point_cloud Global point cloud.
 
void WCP2dToy::Clustering_jump_gap_cosmics(std::vector<PR3DCluster*> &live_clusters, std::vector<PR3DCluster*> &dead_clusters, std::map<int,std::pair<double,double>> &dead_u_index, std::map<int,std::pair<double,double>> &dead_v_index, std::map<int,std::pair<double,double>> &dead_w_index, DynamicToyPointCloud &global_point_cloud)
