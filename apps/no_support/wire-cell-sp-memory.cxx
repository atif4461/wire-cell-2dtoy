 ...
 * @brief Creates a one-dimensional function.
 *
 ...
 * @brief Creates a one-dimensional histogram.
 *
 ...
 * @brief Sets a point in the graph.
 *
...
g1->SetPoint(0,3,5);
 * @brief Allocates memory for arrays of histograms.
 *
...
int nwire_v = 2400;
int nwire_w = 3256;
TH1F **hu = new TH1F*[nwire_u];
TH1F **hv = new TH1F*[nwire_v];
TH1F **hw = new TH1F*[nwire_w];
 * @brief Defines the number of bins per frame.
 
int bins_per_frame = 9600;
 * @brief Loops through each wire and creates a histogram for it.
 *
 * @param i Wire index.
 ...
 * @brief Opens a file.
 *
 * @param root_file Path to the file.
 * @param tpath Path to the tree in the file.
 ...
 * @brief Sets branch status and address for the tree.
 *
...
tfile.Close();
 * @brief Clears and deletes objects.
 
esignal->Clear("D");
delete channelid;
delete esignal;
 * @brief Returns the program execution status.
