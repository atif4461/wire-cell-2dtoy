 ...
 * @brief Constructor for ExecMon class instance.
 *
 * @param message Message to display.
 
ExecMon em("starting");
 * @brief Output operator overload for ExecMon class instance.
 *
 * @param os Output stream object reference.
 * @param em ExecMon class instance reference.
 * @return Output stream object reference.
 
cerr << em("to create a histogram") << endl;
 * @brief Create a one-dimensional function.
 *
 ...
 * @param xlow Lower edge of the first bin along the x-axis.
 * @param xup Upper edge of the last bin along the x-axis.
 
TH1F *h1 = new TH1F("h1","h1",10000,0,10000);
 * @brief Create a graph.
 
TGraph *g1 = new TGraph();
 * @brief Set a point in the graph.
 *
...
//...
 * @brief Destructor for ExecMon class instance.
 
delete h1;
delete f1;
delete g1;
 * @brief Close a ROOT file.
 
tfile.Close();
 * @brief Clear a TClonesArray object.
 *
...
delete channelid;
delete esignal;
 * @brief Program termination message.
