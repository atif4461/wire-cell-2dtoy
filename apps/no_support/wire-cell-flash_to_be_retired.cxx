...
/** * @brief Main entry point for the Wire Cell uBooNE light reconstruction tool.
 *
 * Parses command-line arguments to load geometry data and process specified events from ROOT files,
 * performing light reconstruction tasks and saving output to new ROOT files.
 *
