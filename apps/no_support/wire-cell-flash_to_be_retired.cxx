...
/** * @brief Main entry point for the Wire Cell uBooNE light reconstruction application.
 *
 * Initializes geometry data source, loads event data from ROOT files,
 * performs light reconstruction, and writes output histograms and trees.
 *
