 ...
 * It checks the number of command line arguments and prints usage message if insufficient.
 * It creates a geometry data source object and retrieves its extent.
 * It also creates various data structures and objects for simulation and analysis.
 *
