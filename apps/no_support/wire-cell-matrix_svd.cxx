 ...
 * @brief Add to metric object
 *
 * @param allmcell Cell selection object
 * @param toymatrix Matrix object
 * @param ccmap Charge map object
...
GeomCellSelection allcell = toytiling[i]->get_allcell();
 * @brief Loop through cells
 *
 * @param allcell Cell selection object
...
GeomCellSelection allmcell = mergetiling[i]->get_allcell();
 * @brief Loop through merge cells
 *
 * @param allmcell Merge cell selection object
