 ...
 *
 * Initializes geometry data source, frame data source, and performs various stages of event reconstruction including
 * deconvolution, merging, and clustering. Outputs the results to ROOT files for further analysis.
 *
