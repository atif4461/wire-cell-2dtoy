 ...
 *
 * It initializes variables, reads input files, sets up data sources, 
 * performs event reconstruction, and saves the results.
 *
 ...
 * @brief Function to initialize variables and check command line arguments.
 *
 * Checks if the number of command line arguments is sufficient and 
 * initializes variables such as geometry data source, frame data source, etc.
 
void initVariables()
{
  // implementation...
}
 * @brief Function to set up geometry data source and retrieve its extent.
 *
 * Creates a geometry data source object and retrieves its spatial extent.
 * @param path Path to the geometry file.
 * @return Vector of doubles representing the extent.
 
std::vector<double> setupGeometry(const char* path)
{
  // implementation...
}
 * @brief Function to perform event reconstruction.
 *
 * Performs event reconstruction using various algorithms and techniques.
 * @param gds Geometry data source.
 * @param fds Frame data source.
 * @param eve_num Event number.
 * @return None.
 
void reconstructEvent(WCPSst::GeomDataSource& gds, WCP::FrameDataSource& fds, int eve_num)
{
  // implementation...
}
 * @brief Function to save results to a file.
 *
 * Saves the reconstructed events and other results to a file.
...
void saveResults(TFile* file, WCPSst::GeomDataSource& gds, WCP::FrameDataSource& fds, int eve_num)
{
  // implementation...
}
 * @brief Function to calculate metrics and print them.
 *
 * Calculates and prints various metrics such as chi-squared and NDF.
 * @param toymetric Toy metric object.
 * @return None.
 
void calculateMetrics(WCP2dToy::ToyMetric& toymetric)
{
  // implementation...
