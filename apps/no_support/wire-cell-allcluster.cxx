 ...
 * @brief Creates a geometry data source object from the provided file path.
 *
 * @param argv[1] File path to the geometry data source.
...
cerr << "Extent: "
     ...
     << " z:" << ex[2]/units::m << " m"
     << endl;
 * @brief Retrieves the pitch values for each wire plane type.
 *
 * @param WirePlaneType_t(0) First wire plane type.
 * @param WirePlaneType_t(1) Second wire plane type.
 * @param WirePlaneType_t(2) Third wire plane type.
...
cout << "Pitch: " << gds.pitch(WirePlaneType_t(0)) 
     ...
     << endl;
 * @brief Retrieves the angle values for each wire plane type.
 *
 * @param WirePlaneType_t(0) First wire plane type.
 * @param WirePlaneType_t(1) Second wire plane type.
 * @param WirePlaneType_t(2) Third wire plane type.
 * @return Angle values for each wire plane type.
 
cout << "Angle: " << gds.angle(WirePlaneType_t(0)) 
     << " " << gds.angle(WirePlaneType_t(1)) 
     << " " << gds.angle(WirePlaneType_t(2))
     << endl;
 * @brief Opens a ROOT file for reading event data.
 *
 * @param argv[2] File path to the event data file.
...
Trun->GetEntry(0);
 * @brief Configures parameters for the TPC.
 ...
 * @brief Initializes variables for tracking.
 ...
 * @brief Loops through events and performs tracking.
 
for (int i=0;i!=TC->GetEntries();i++){
  TC->GetEntry(i);
  //...
}
 * @brief Saves tracks to a new ROOT file.
 
TFile *file1 = new TFile("cluster_tracking.root","RECREATE");
TTree *T1 = new TTree("T_goodtrack","T_goodtrack");
//...
 * @brief Writes trees to the new ROOT file.
