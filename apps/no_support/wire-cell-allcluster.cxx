 ...
 *
 * @param argv[1] Path to shower_3D.root file.
 
WCPSst::GeomDataSource gds(argv[1]);
 * @brief Retrieves extent of the geometry data source.
 *
 * @return Vector of doubles representing the extent.
 
std::vector<double> ex = gds.extent();
 * @brief Prints extent of the geometry data source.
...
cerr << "Extent: "
     ...
     << " z:" << ex[2]/units::m << " m"
     << endl;
 * @brief Retrieves and prints pitch values for each wire plane type.
 
cout << "Pitch: " << gds.pitch(WirePlaneType_t(0)) 
     << " " << gds.pitch(WirePlaneType_t(1)) 
     << " " << gds.pitch(WirePlaneType_t(2))
     << endl;
 * @brief Retrieves and prints angle values for each wire plane type.
