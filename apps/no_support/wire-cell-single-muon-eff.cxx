...
cerr << "Extent: "
     ...
     << " z:" << ex[2]/units::m << " m"
     << endl;
 * @brief Calculates pitches and angles for different planes.
...
cout << "Angle: " << gds.angle(WirePlaneType_t(0)) 
     ...
     << endl;
 * @brief Opens file specified by filename.
 
TString filename = argv[2];
 * @brief Initializes event number.
 
int eve_no = atoi(argv[3]);
 * @brief Opens files for reading and writing.
 
TFile *file = new TFile(filename);
TTree *TC = (TTree*)file->Get("TC");
TTree *Trun = (TTree*)file->Get("Trun");
TTree *TMC = (TTree*)file->Get("TMC");
 * @brief Declares variables for storing tree branch values.
 
float unit_dis;
int nrebin;
int total_time_bin;
 * @brief Sets up branches for trees.
...
Trun->GetEntry(0);
 * @brief Configures singleton instance with parameters.
