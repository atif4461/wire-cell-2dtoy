...
cerr << "Extent: "
     ...
     << " z:" << ex[2]/units::m << " m"
     << endl;
 * @brief Sets up frame data source and simulation parameters.
 
const char* root_file = argv[2];
const char* tpath = "/Event/Sim";
WCP::FrameDataSource* fds = 0;
fds = WCPSst::make_fds(root_file);
 * @brief Performs event processing and analysis.
 
for (int i=352;i!=sds.size();i++){
     * @brief Jumps to specific event in the data source.
   
  sds.jump(i);
  WCP::Slice slice = sds.get();

     * @brief Creates ToyTiling objects for event analysis.
  ...
  WCP2dToy::TruthToyTiling *truthtiling = new WCP2dToy::TruthToyTiling(*toytiling,pvv,i,gds);
     ...
     * @brief Analyzes event data and calculates charges.
   
  CellChargeMap ccmap = truthtiling->ccmap();
  WireChargeMap wcmap = toytiling->wcmap();

     * @brief Performs checks and calculations for single cell and merged cell analyses.
   
  //... (rest of the code remains the same)
 * @brief Displays results using ToyEventDisplay.
 ...
 * @brief Configures graphics styles and colors.
 
gStyle->SetOptStat(0);
//... (rest of the code remains the same)
 * @brief Runs the application and displays results.
 
theApp.Run();
 * @brief Cleans up and returns exit status.
