...
/** * @brief Main entry point for the Wire Cell UBOONE signal processing tool.
 *
 * Parses command-line arguments to configure geometry data source and ROOT file paths,
 * initializes histograms and graphs for signal processing, performs deconvolution using
 * LASSO regression, applies Gaussian filtering, and writes processed signals to output files.
 *
