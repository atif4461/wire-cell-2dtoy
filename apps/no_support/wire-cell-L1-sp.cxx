...
/** * @brief Main function to process UBOONE detector data.
 *
 * This function initializes necessary parameters, reads geometry data,
 * processes raw and deconvolved signals, applies a lasso model for fitting,
 * performs FFT operations, and writes the processed data to output files.
 *
