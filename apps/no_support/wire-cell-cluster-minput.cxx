 ...
 * @brief Load channel wire geometry data source.
 *
 * @param filename File name of the geometry data source.
 * @return GeomDataSource object.
 
WCPSst::GeomDataSource gds(const std::string& filename)
 * @brief Get extent of the geometry data source.
 *
 * @return Vector of doubles representing the extent.
 
std::vector<double> get_extent()
 * @brief Get pitch of a specific wire plane type.
 *
 * @param plane_type Type of wire plane.
 * @return Pitch value.
 
double pitch(WirePlaneType_t plane_type)
 * @brief Get angle of a specific wire plane type.
 *
 * @param plane_type Type of wire plane.
 * @return Angle value.
 
double angle(WirePlaneType_t plane_type)
 * @brief Get wire distance of a specific wire.
 *
 * @param wire Wire object.
 * @return Distance value.
 
double wire_dist(const GeomWire& wire)
 * @brief Add wire to a cell.
 *
 * @param wire Wire object.
 * @param plane_type Type of wire plane.
...
void AddWire(const GeomWire& wire, WirePlaneType_t plane_type, double charge, double error)
 * @brief Set time slice of a cell.
 *
 * @param time_slice Time slice value.
 
void SetTimeSlice(int time_slice)
 * @brief Create point cloud for a cluster.
 
void Create_point_cloud()
 * @brief Calculate shortest paths using Dijkstra's algorithm.
 *
 * @param start Starting point.
 * @param end Ending point.
 
void dijkstra_shortest_paths(const WCPointCloud<double>::WCPoint& start, const WCPointCloud<double>::WCPoint& end)
 * @brief Perform fine tracking.
