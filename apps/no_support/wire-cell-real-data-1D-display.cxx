 ...
 * @brief Save original data to file.
 *
 * Saves the original data to a file named "1D_display_<run_no>_<subrun_no>_<eve_num>.root".
 
TFile *file = new TFile(Form("1D_display_%d_%d_%d.root",run_no,subrun_no,eve_num),"RECREATE");

//... rest of the code remains the same...
 * @brief Fill tree with bad channels.
 *
 * Fills a tree named "T_bad" with bad channels.
