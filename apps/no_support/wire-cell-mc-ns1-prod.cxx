...
void PrintGeometryExtent(const WCPSst::GeomDataSource& gds)
 * @brief Function to print pitch and angle of wire planes.
 *
 * @param gds Geometry data source object.
 * @return None
 
void PrintWirePlanesInfo(const WCPSst::GeomDataSource& gds)
 * @brief Function to process tree data.
 *
 * @param filename File name of tree data.
 * @param eve_no Event number.
 * @return None
 
void ProcessTreeData(const std::string& filename, int eve_no)
 * @brief Function to set parameters for space cell selection.
 *
 * @param gds Geometry data source object.
...
void SetSpaceCellParameters(const WCPSst::GeomDataSource& gds, int nrebin, float unit_dis, int total_time_bin)
 * @brief Function to create ToyTiling objects.
 *
 * @param ntime Number of time slices.
 * @return Array of ToyTiling pointers.
 
WCP2dToy::ToyTiling** CreateToyTilings(int ntime)
 * @brief Function to fill trees with track data.
 *
 * @param trackings Vector of ToyTracking pointers.
 * @return None
 
void FillTreesWithTrackData(const std::vector<WCP2dToy::ToyTracking*>& trackings)
 * @brief Function to write trees to file.
 *
 * @param file1 Pointer to output file.
 * @return None
 
void WriteTreesToFile(TFile* file1)
