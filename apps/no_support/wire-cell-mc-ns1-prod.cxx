 ...
 *
 * @param filename File name of ROOT file.
 * @return Pointer to opened ROOT file.
 
TFile *file = new TFile(filename)
 * @brief Get tree from ROOT file.
 *
 * @param treename Name of tree to retrieve.
 * @return Pointer to retrieved tree.
 
TTree *TC = (TTree*)file->Get("TC")
 * @brief Set branch address for tree.
 *
 * @param branchnames Names of branches to set addresses for.
 * @param addr Addresses to set for branches.
 ...
 * @brief Loop through entries in tree.
 *
 * @param num_entries Number of entries to loop through.
 
for (int i=0;i!=TC->GetEntries();i++)
 * @brief Add cell to toy tiling.
 *
 ...
 * @brief Create crawler object.
 *
 * @param mcells Merge space cell selection.
 * @param param Parameter value.
 
WCP2dToy::ToyCrawler* toycrawler = new WCP2dToy::ToyCrawler(mcells,1,2)
 * @brief Form graph for crawler.
 ...
 * @brief Fill tree with tracker data.
 *
 * @param tree Tree to fill.
 * @param tracks Tracker data.
...
T5->Fill()
T6->Fill()
 * @brief Create cosmic object.
 *
 * @param trackings Tracking objects.
 
WCP2dToy::ToyCosmic toycosmic(trackings)
 * @brief Fill tree with cosmic data.
 *
 * @param tree Tree to fill.
 * @param cosmic Cosmic object.
