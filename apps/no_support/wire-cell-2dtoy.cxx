 ...
 * It checks the number of command line arguments and prints usage message if invalid.
 * It creates a geometry data source object and retrieves its extent.
 * It also initializes various objects for event display and runs the application.
 *
