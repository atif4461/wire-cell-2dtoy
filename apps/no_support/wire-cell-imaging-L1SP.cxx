...
/**
 * @brief Compares two GeomWireSelection objects
 * 
 * This function compares the size and contents of two GeomWireSelection objects.
 * It returns true if the first object is larger or has a higher identifier,
 * and false otherwise.
 * 
 * @param a The first GeomWireSelection object to compare
 * @param b The second GeomWireSelection object to compare
 * @return True if a is larger or has a higher identifier, false otherwise
 ...
 * @brief Loops through time slices and performs calculations.
 
for (int i=start_num;i!=end_num+1;i++) {
         * @brief Jumps to specific time slice in data source.
     
    sds.jump(i);
    WCP::Slice slice = sds.get();
    WCP::Slice slice_err = sds.get_error();

         * @brief Resets cells for current time slice.
