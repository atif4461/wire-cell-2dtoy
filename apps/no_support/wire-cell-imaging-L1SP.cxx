 ...
 *
 * @param a First geometric wire selection to compare.
 * @param b Second geometric wire selection to compare.
 ...
 * @brief Loads geometry data from a file.
 *
 * @param filename Name of the file containing geometry data.
 
WCPSst::GeomDataSource::GeomDataSource(const char* filename)
 * @brief Gets the extent of the geometry.
 *
 * @return Vector of doubles representing the extent.
 
std::vector<double> WCPSst::GeomDataSource::extent()
 * @brief Gets the pitch of a wire plane.
 *
 ...
 * @brief Sets the pitch of the U plane.
 *
 * @param pitch_u Pitch of the U plane.
 
void TPCParams::set_pitch_u(double pitch_u)
 * @brief Sets the pitch of the V plane.
 *
 * @param pitch_v Pitch of the V plane.
 
void TPCParams::set_pitch_v(double pitch_v)
 * @brief Sets the pitch of the W plane.
 *
 * @param pitch_w Pitch of the W plane.
 
void TPCParams::set_pitch_w(double pitch_w)
 * @brief Sets the time slice width.
 *
 * @param ts_width Time slice width.
 
void TPCParams::set_ts_width(double ts_width)
 * @brief Gets the pitch of the U plane.
 *
 * @return Pitch of the U plane.
 
double TPCParams::get_pitch_u()
 * @brief Gets the pitch of the V plane.
 *
 * @return Pitch of the V plane.
 
double TPCParams::get_pitch_v()
 * @brief Gets the pitch of the W plane.
 *
 * @return Pitch of the W plane.
 
double TPCParams::get_pitch_w()
 * @brief Gets the time slice width.
 *
 * @return Time slice width.
 
double TPCParams::get_ts_width()
 * @brief Creates a new TFile object.
 *
 * @param filename Name of the file to open.
 * @param mode Mode in which to open the file.
 
TFile::TFile(const char* filename, const char* mode)
 * @brief Opens a tree from a file.
 *
 * @param treename Name of the tree to open.
 * @return Pointer to the opened tree.
 
TTree* TFile::Get(const char* treename)
 * @brief Sets the branch address for a variable.
 *
 * @param branchname Name of the branch.
 * @param address Address of the variable.
 
void TTree::SetBranchAddress(const char* branchname, void* address)
 * @brief Gets an entry from the tree.
 *
 * @param entry Entry number to retrieve.
 
void TTree::GetEntry(Int_t entry)
 * @brief Creates a new TH1F object.
 *
 * @param name Name of the histogram.
 
TH1F::TH1F(const char* name)
 * @brief Gets the content of a bin.
 *
 * @param bin Bin number.
 * @return Content of the bin.
 
Double_t TH1F::GetBinContent(Int_t bin)
 * @brief Creates a new TH2F object.
 *
 * @param name Name of the histogram.
 
TH2F::TH2F(const char* name)
 * @brief Adds wires to the L1SP algorithm.
 *
 * @param index Index at which to add the wires.
 * @param wires Wires to add.
 
void WCP2dToy::uBooNE_L1SP::AddWires(Int_t index, GeomWireSelection wires)
 * @brief Forms ROIs.
 *
 * @param size Size of the ROIs.
 
void WCP2dToy::uBooNE_L1SP::Form_rois(Int_t size)
 * @brief Refreshes the data source.
 *
...
void WCP2dToy::pdDataFDS::refresh(TH2F* hu_decon, TH2F* hv_decon, TH2F* hw_decon, Int_t eve_num)
 * @brief Jumps to a specific event.
 *
 * @param index Index of the event to jump to.
 
void WCP2dToy::pdDataFDS::jump(Int_t index)
 * @brief Gets the slice data.
 *
 * @return Slice data.
 
WCP::Slice WCP2dToy::pdDataFDS::get()
 * @brief Resets the cells.
 
void WCP2dToy::LowmemTiling::reset_cells()
 * @brief Initializes bad cells.
 *
 * @param uplane_map Map of U plane wires.
 * @param vplane_map Map of V plane wires.
 * @param wplane_map Map of W plane wires.
 
void WCP2dToy::LowmemTiling::init_bad_cells(std::map<Int_t, std::pair<Int_t, Int_t> > uplane_map, std::map<Int_t, std::pair<Int_t, Int_t> > vplane_map, std::map<Int_t, std::pair<Int_t, Int_t> > wplane_map)
 * @brief Checks bad cells against a previous set.
 *
...
void WCP2dToy::LowmemTiling::check_bad_cells(WCP2dToy::LowmemTiling* prev, std::map<Int_t, std::pair<Int_t, Int_t> > uplane_map, std::map<Int_t, std::pair<Int_t, Int_t> > vplane_map, std::map<Int_t, std::pair<Int_t, Int_t> > wplane_map)
 * @brief Initializes good cells.
 *
...
void WCP2dToy::LowmemTiling::init_good_cells(WCP::Slice slice, WCP::Slice slice_err, std::vector<Float_t> uplane_rms, std::vector<Float_t> vplane_rms, std::vector<Float_t> wplane_rms)
 * @brief Finds L1SP wires.
 *
 * @return Selection of wires.
