 ...
 *
 * It initializes variables, reads input parameters, sets up the simulation,
 * and performs the reconstruction and analysis tasks.
 *
 ...
 * @brief Function to check command line arguments and print usage message if invalid.
 *
...
cerr << "Extent: "
     ...
     << " z:" << ex[2]/units::m << " m"
     << endl;
 * @brief Simulates raw waveform and deconvolves signals.
 *
 * Creates instances of signal simulator and deconvolver classes.
 
WCP2dToy::ToySignalSimuTrueFDS *st_fds = new WCP2dToy::ToySignalSimuTrueFDS(*gfds,gds,total_time_bin/nrebin,max_events,0);
...
WCP2dToy::ToySignalGausFDS *gaus_fds = new WCP2dToy::ToySignalGausFDS(*simu_fds,gds,total_time_bin/nrebin,max_events,toffset_1,toffset_2);
WCP2dToy::ToySignalWienFDS *wien_fds = new WCP2dToy::ToySignalWienFDS(*simu_fds,gds,total_time_bin/nrebin,max_events,toffset_1,toffset_2);
 * @brief Performs tiling and merging operations.
 *
 * Creates instances of tiler and merger classes.
 ...
 * @brief Solves linear systems and computes metrics.
 *
 * Creates instances of matrix solver and metric calculator classes.
 
WCP2dToy::ToyMatrix **toymatrix = new WCP2dToy::ToyMatrix*[2400];
WCP2dToy::ToyMetric toymetric;
WCP2dToy::BlobMetric blobmetric;
 * @brief Saves results to output files.
 *
 * Writes data to output trees and files.
 ...
 * @brief Finalizes and cleans up resources.
 *
 * Deletes dynamically allocated objects and closes output files.
