...
/**
 * @brief Constructor for uBooNE light reconstruction class
 * @param root_file Path to the input ROOT file
...
/**
 * Destructor for uBooNE light reconstruction class.
 * 
 * Releases memory allocated for various histograms and data structures.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 * 
 * This function takes an event number as input, loads the corresponding raw data 
 * from the ROOT file, and stores it in various member variables of the class.
 * It also performs some initial processing steps such as merging and reordering 
 * the raw waveforms, grouping optical hits, and calculating gains and timestamps.
 * 
 * @param eve_num The event number to be loaded.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Loads an event from the input data.
 * 
 * This function loads the event data from the input file, including the 
 * waveform, timestamps, gains, and other relevant information. It also 
 * processes the data to create a list of optical hits and groups them into 
 * flashes.
 * 
...
/**
 * Sorts flashes into separate sets to remove duplicates and maintains original order
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Corrects the baseline of raw histograms.
 *
 * Resets and fills histograms, calculates baselines, and subtracts them from raw data.
 *
 * @param none
 * @return void
 
void WCP2dToy::uBooNE_light_reco::Process_beam_wfs(){
   * @brief Deconvolutes raw waveforms.
 *
 * Performs FFT, divides by RC and SPE responses, applies filters, and transforms back.
 *
 * @param none
 * @return void
 
   * @brief Finds regions of interest in deconvoluted waveforms.
 *
 * Identifies peaks, sets flags, and solves for baselines.
 *
 * @param none
 * @return void
 
   * @brief Prepares L1 fits.
 *
 * Rebins data, creates matrices, and sets up linear algebra.
 *
 * @param none
 * @return void
 
   * @brief Performs L1 fits.
 *
 * Uses Lasso model to fit data.
 *
 * @param none
 * @return void
 
   * @brief Calculates total PE and multiplicity.
 *
 * Sums PE and counts multiplicity across all channels.
 *
 * @param none
 * @return void
 
   * @brief Identifies flashes.
 *
 * Applies thresholds, checks for adjacent flashes, and adds to list.
 *
 * @param none
 * @return void
 
   * @brief Merges cosmic and beam flashes.
 *
 * Compares times, removes overlaps, and combines lists.
 *
 * @param none
 * @return void
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
...
/**
 * @brief Calculates the mean and RMS of a histogram
 * 
 * This function calculates the mean and root mean square of a given histogram.
 * It creates a new histogram, fills it with the contents of the input histogram,
 * and then uses this new histogram to calculate the mean and RMS.
 * 
 * @param hist The input histogram
 * @param nbin The number of bins in the histogram
 * @return A pair containing the calculated mean and RMS
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Merges raw beam data from high gain and low gain wires
 * 
 * @param[in] hg_wf High gain wire waveform array
 * @param[in] hg_chan High gain channel numbers
 * @param[in] hg_timestamp High gain timestamps
 * @param[in] lg_wf Low gain wire waveform array
 * @param[in] lg_chan Low gain channel numbers
 * @param[in] lg_timestamp Low gain timestamps
 * @param[in] beamDisc Flag to discriminate between beam and non-beam events
 * @param[in] OpChanToOpDet Mapping of operational channels to operational detectors
 * @param[out] ctr Counter for merged beam data
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Merges raw cosmic waveforms from high gain and low gain channels.
 * 
 ...
 * @param beamDisc Flag indicating whether beam discrimination is applied
 * @param OpChanToOpDet Mapping of opchannel to opdet
...
/**
 * Reorders merged waveform data for beam and cosmic events.
 *
 * This function takes in several parameters including beam and cosmic waveforms,
 * corresponding FEMCH numbers, and timestamps. It reorganizes the data into a new order
 * based on the FEMCH numbers and stores the reordered waveforms and timestamps.
 *
 * @param beam_wf Beam waveform data
 * @param beam_femch Corresponding FEMCH numbers for beam waveforms
 * @param beam_timestamp Timestamps for beam waveforms
 * @param cosmic_wf Cosmic waveform data
 * @param cosmic_femch Corresponding FEMCH numbers for cosmic waveforms
...
/**
 * @brief Calculates scaling factor for light reconstruction
 * 
 * This function calculates the scaling factor for light reconstruction 
 * based on the opdet number.
 * 
