...
/**
 * Constructor for uBooNE_light_reco class.
 *
 * Initializes member variables and sets up histograms and data structures.
 *
 * @param root_file Name of the ROOT file to open.
...
/**
 * Destructor for the uBooNE light reconstruction object 
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Loads raw event data from a file and processes it.
 *
 * This function loads raw event data from a file, merges the beam and cosmic waveforms,
 * reorders the merged waveforms, groups optical hits, and creates Opflash objects.
 *
 * @param eve_num The event number to load.
  
 * @brief Merges raw beam waveforms and optical channel data.
 *
 * This function merges the high-gain and low-gain beam waveforms and optical channel data.
 *
 * @param beam_hg_wf High-gain beam waveform.
 * @param beam_hg_opch High-gain beam optical channel data.
 * @param beam_hg_timestamp High-gain beam timestamp data.
 * @param beam_lg_wf Low-gain beam waveform.
 * @param beam_lg_opch Low-gain beam optical channel data.
 * @param beam_lg_timestamp Low-gain beam timestamp data.
 * @param is_beam Flag indicating whether the data is beam or cosmic.
 * @param opch_to_opdet Mapping from optical channels to optical detectors.
 * @param ctr Beam or cosmic counter.
 
 * @brief Merges raw cosmic waveforms and optical channel data.
 *
 * This function merges the high-gain and low-gain cosmic waveforms and optical channel data.
 *
 * @param cosmic_hg_wf High-gain cosmic waveform.
 * @param cosmic_hg_opch High-gain cosmic optical channel data.
 * @param cosmic_hg_timestamp High-gain cosmic timestamp data.
 * @param cosmic_lg_wf Low-gain cosmic waveform.
 * @param cosmic_lg_opch Low-gain cosmic optical channel data.
 * @param cosmic_lg_timestamp Low-gain cosmic timestamp data.
 * @param is_beam Flag indicating whether the data is beam or cosmic.
 * @param opch_to_opdet Mapping from optical channels to optical detectors.
 * @param ctr Beam or cosmic counter.
 
 * @brief Reorders the merged waveforms.
 *
 * This function reorders the merged beam and cosmic waveforms.
 *
 * @param fop_wf_beam Merged beam waveform.
 * @param fop_femch_beam Merged beam optical channel data.
 * @param fop_timestamp_beam Merged beam timestamp data.
 * @param fop_wf_cosmic Merged cosmic waveform.
 * @param fop_femch_cosmic Merged cosmic optical channel data.
 * @param fop_timestamp_cosmic Merged cosmic timestamp data.
 
 * @brief Groups optical hits into clusters.
 *
 * This function groups optical hits into clusters based on their timestamps.
 *
 * @param ophits_group Vector of vectors containing grouped optical hits.
 
 * @brief Creates an Opflash object from a group of optical hits.
 *
 * This function creates an Opflash object from a group of optical hits.
 *
 * @param ophits_group Group of optical hits.
 
 * @brief Processes the beam waveforms.
 *
 * This function processes the beam waveforms by subtracting a pedestal value and storing the result.
 *
 * @param hsignal Input histogram.
 * @param hraw Output histogram.
 * @param gain Gain values.
 * @param beam_dt Timestamp differences.
 
 * @brief Sorts the flashes.
 *
 * This function sorts the flashes in some order.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Loads event data from a file and processes it to extract relevant information.
 *
 * @param eve_num The event number to load.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Removes duplicate elements from flash sets by converting them to sets and back to vectors.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Process beam waveforms to extract features and identify flashes.
 *
 * This function processes the beam waveforms by correcting the baseline, 
 * performing deconvolution, and identifying flashes.
 *
 * @return None
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Calculates the mean and RMS of a histogram after filtering out extreme values.
 *
...
/**
 * Merges raw beam data from high gain and low gain waveforms.
 *
 * @param hg_wf High gain waveform array
 * @param hg_chan High gain channel vector
 * @param hg_timestamp High gain timestamp vector
 * @param lg_wf Low gain waveform array
 * @param lg_chan Low gain channel vector
 * @param lg_timestamp Low gain timestamp vector
 * @param beamDisc Beam discrimination flag
 * @param OpChanToOpDet Mapping of operation channels to operation detectors
 * @param ctr Counter variable
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Merges raw cosmic waveforms from high gain and low gain channels.
 *
 * @param hg_wf High gain waveforms
 * @param hg_chan High gain channel numbers
 * @param hg_timestamp High gain timestamps
 * @param lg_wf Low gain waveforms
 * @param lg_chan Low gain channel numbers
 * @param lg_timestamp Low gain timestamps
 * @param beamDisc Flag indicating whether to apply beam discrimination
 * @param OpChanToOpDet Mapping from op channel to op detector
 * @param ctr Index counter
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Reorders merged waveforms from beam and cosmic events.
 *
 * This function takes in several parameters including beam and cosmic waveforms, 
 * their corresponding FEMCH numbers and timestamps. It reorders these events 
 * based on their FEMCH numbers and stores them in output vectors.
 *
 * @param beam_wf Beam waveforms
 * @param beam_femch FEMCH numbers for beam waveforms
 * @param beam_timestamp Timestamps for beam waveforms
 * @param cosmic_wf Cosmic waveforms
 * @param cosmic_femch FEMCH numbers for cosmic waveforms
 * @param cosmic_timestamp Timestamps for cosmic waveforms
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Returns the scaling factor for a given opdet
 * @param opdet The opdet number
 * @return The corresponding scaling factor
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
