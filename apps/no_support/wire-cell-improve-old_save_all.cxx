 ...
 *
 * It checks the command line arguments, initializes variables and data structures,
 * retrieves geometry extent, sets up the simulation, solves the linear system,
 * performs clustering, crawling, and saves the results to a file.
 *
