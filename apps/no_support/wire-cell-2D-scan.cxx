...
/** * @brief Main entry point for the wire cell uboone data processing application.
 *
 * Initializes geometry data source, reads raw data frames, applies deconvolution with Wiener filter,
 * and saves processed data to a ROOT file.
 *
