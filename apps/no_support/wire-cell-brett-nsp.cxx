 ...
 * creates a geometry data source object, gets the extent of the geometry,
 * and performs various operations related to data processing and analysis.
 *
 ...
 * @brief Saves original data to a file.
 *
 * Opens a file in read mode, sets branch statuses, and saves data.
 ...
 * @brief Fills histograms with data from the tree.
 *
 * Loops through channels, fills histograms with signal data.
 
for (size_t ind=0; ind < nchannels; ++ind) {
  TH1F* signal = dynamic_cast<TH1F*>(esignal->At(ind));
  int chid = channelid->at(ind);
  //...
 * @brief Writes trees to a file.
 *
 * Creates trees, sets branches, and writes them to a file.
