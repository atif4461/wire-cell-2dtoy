 ...
 * It reads command line arguments, sets up the geometry data source,
 * and performs various operations such as deconvolution and data processing.
 *
 ...
 *
 * This function prints the usage message and returns an error code.
 *
 * @return Error code.
 ...
 *
 * This section initializes various variables and data structures used throughout the program.
 ...
 * @brief Prints geometry extent and pitch information.
 *
 * This section prints the geometry extent and pitch information for debugging purposes.
...
cout << "Angle: " << gds.angle(WirePlaneType_t(0)) 
     ...
     << endl;
 * @brief Sets up constants and thresholds.
 *
 * This section sets up various constants and thresholds used in the program.
...
int time_offset = -92.;
 * @brief Opens output file and sets up trees.
 *
 * This section opens the output file and sets up the trees for storing data.
 ...
 *
 * This section fills the trees with data from the input files and calculations.
 
//... (rest of the code remains the same)
 * @brief Writes and closes the output file.
 *
 * This function writes the filled trees to the output file and closes it.
...
int main(int argc, char* argv[])
{
  ...
  WCPSst::DatauBooNEFrameDataSource data_fds(root_file,gds,total_time_bin,1);
  if (save_file != 2){
