 ...
 * @brief Function to print extent of geometry data source.
 *
 * @param gds Geometry data source object.
 * @return None
 
void PrintExtent(const WCPSst::GeomDataSource& gds)
 * @brief Function to print pitch values of wire planes.
 *
 * @param gds Geometry data source object.
 * @return None
 
void PrintPitchValues(const WCPSst::GeomDataSource& gds)
 * @brief Function to print angle values of wire planes.
 *
 * @param gds Geometry data source object.
 * @return None
 
void PrintAngleValues(const WCPSst::GeomDataSource& gds)
 * @brief Function to set up TPC parameters.
 *
 * @param gds Geometry data source object.
 * @param nrebin Rebin value.
 * @param unit_dis Unit distance value.
 * @param total_time_bin Total time bin value.
 * @return None
 
void SetUpTPCParameters(const WCPSst::GeomDataSource& gds, int nrebin, float unit_dis, int total_time_bin)
 * @brief Function to process tree entries.
 *
...
void ProcessTreeEntries(TTree* TC, TTree* Trun, const WCPSst::GeomDataSource& gds, int eve_no)
 * @brief Function to fill trees.
 *
 * @param T1 Tree object.
 * @param T2 Tree object.
 * @param T3 Tree object.
 * @param T4 Tree object.
 * @param T5 Tree object.
 * @param T6 Tree object.
 * @param trackings Tracking objects.
 * @return None
 
void FillTrees(TTree* T1, TTree* T2, TTree* T3, TTree* T4, TTree* T5, TTree* T6, const std::vector<WCP2dToy::ToyTracking*>& trackings)
 * @brief Function to write trees to file.
 *
...
void WriteTreesToFile(TFile* file1, TTree* T1, TTree* T2, TTree* T3, TTree* T4, TTree* T5, TTree* T6)
