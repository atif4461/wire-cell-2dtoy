 ...
 * @brief Initializes sets for storing cell selections.
 ...
 * @brief Second loop over events for processing simple blobs.
 
for (int i=start_num;i!=end_num+1;i++) {
     * @brief Checks if simple blob reduction is enabled.
   
  if (toymatrix[i]->GetSimpleBlobReduction()) {
         * @brief Creates simple blob tiling object.
    ...
    if (i==start_num) {
      ...
      blobtiling[i] = new WCP2dToy::SimpleBlobToyTiling(*toytiling[i],*mergetiling[i],*toymatrix[i],*mergetiling[i-1],*toymatrix[i-1],*mergetiling[i+1],*toymatrix[i+1]);
         ...
         * @brief Saves blob cells and updates blob metric.
 ...
 * @brief Configures display object.
