...
int main(int argc, char* argv[])
{
  ...
  //WCP::GenerativeFDS gfds(toydep,gds,9600,max_events,0.5*1.605723*units::millimeter); // 87 K at 0.5 kV/cm
  WCP::GenerativeFDS gfds(toydep,gds,9600,max_events,0.5*1.60*units::millimeter); // 87 K at 0.5 kV/cm
  

  WCP2dToy::ToySignalSimuTrueFDS st_fds(gfds,gds,9600/4,5,0); //truth
