...
/** * @brief Main function to process UBOONE detector data including geometry loading, cluster formation,
 *        light matching, and outputting processed data to ROOT files.
 *
 * This function initializes necessary parameters, loads geometric data, processes TPC clusters from input files,
 * performs clustering operations, matches TPC clusters with optical flashes, and writes out the results to multiple ROOT trees.
 *
 * @param argc Number of command-line arguments passed to the program.
 * @param argv Command-line argument array containing paths to geometry, imaging, and light data files.
 * @return Integer exit status of the program where 0 indicates successful completion and non-zero values indicate errors.
