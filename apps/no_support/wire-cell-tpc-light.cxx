...
/** * @brief Main entry point for the Wire Cell UBOONE application.
 *
 * Initializes the application, loads geometry data, processes imaging data,
 * performs clustering, matches TPC clusters with optical flashes, and writes
 * processed data to output files.
 *
 * @param argc Number of command-line arguments.
 * @param argv Array of command-line argument strings.
 * @return Integer exit status of the application.
