 ...
 * @brief Load channel wire geometry from file.
 *
...
void process_light_info(WCP::ToyLightReco& uboone_flash, const char* root_file) {
}
 ...
 * @brief Save matched bundles to file.
 *
 * @param file1 Output file pointer.
 * @param matched_bundles Matched bundles object.
 * @return None
 
void save_matched_bundles(TFile* file1, FlashTPCBundleSelection& matched_bundles) {
}
...
void save_raw_waveform_data(TFile* file1, WCP::ToyLightReco& uboone_flash) {
}
 * @brief Save flash data to file.
 *
 * @param file1 Output file pointer.
 * @param flashes Flash selection object.
 * @return None
 
void save_flash_data(TFile* file1, WCP::OpflashSelection& flashes) {
}
