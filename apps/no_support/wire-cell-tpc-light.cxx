...
void setup_tpc_params(TPCParams& mp, GeomDataSource& gds, int nrebin, int frame_length, double unit_dis)
 * @brief Process light information from file.
 *
 * @param uboone_flash Toy light reconstruction object.
 * @param root_file Root file name.
 * @param eve_num Event number.
 * @return None
 
void process_light_info(WCP2dToy::ToyLightReco& uboone_flash, const char* root_file, int eve_num)
 * @brief Perform TPC-light matching.
 *
 * @param time_offset Time offset.
 * @param nrebin Rebinning factor.
 * @param group_clusters Cluster grouping map.
 * @param flashes Flash selection object.
 * @return Matched bundles.
 
FlashTPCBundleSelection tpc_light_match(double time_offset, int nrebin, std::map<PR3DCluster*,std::vector<std::pair<PR3DCluster*,double>>> group_clusters, WCP::OpflashSelection& flashes)
 * @brief Save matched results to file.
 *
 * @param file1 Output file pointer.
 * @param matched_bundles Matched bundles.
 * @param live_clusters Live cluster selection.
 * @return None
 
void save_matched_results(TFile* file1, FlashTPCBundleSelection matched_bundles, PR3DClusterSelection live_clusters)
 * @brief Save raw waveform data to file.
 *
 * @param file1 Output file pointer.
 * @param uboone_flash Toy light reconstruction object.
 * @return None
 
void save_raw_waveform_data(TFile* file1, WCP2dToy::ToyLightReco& uboone_flash)
