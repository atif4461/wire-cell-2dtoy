...
/** * @brief Main entry point for processing shower data in the MicroBooNE experiment.
 *
 * This function initializes various parameters, loads geometry and simulation data,
 * performs signal simulation, applies filters, and reconstructs showers. The reconstructed
 * data is then saved to output files along with true Monte Carlo information.
 *
