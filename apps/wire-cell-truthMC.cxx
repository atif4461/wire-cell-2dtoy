 ...
 *
 * Initializes geometry data source, sets up parameters, reads ROOT files containing Monte Carlo and simulated data,
 * performs various stages of reconstruction including deconvolution, slicing, merging, and clustering,
 * and saves the results to output ROOT files.
 *
