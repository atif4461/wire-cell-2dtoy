...
/** * @brief Main function to execute the shower reconstruction pipeline for the UBOONE detector.
 *
 * This function initializes necessary parameters, loads geometry data, reads ROOT files containing Monte Carlo and reconstructed data,
 * performs signal simulation, deconvolution, and clustering, and finally saves the results to output ROOT files.
 *
 * @param argc Number of command-line arguments.
 * @param argv Command-line argument array.
 * @return Integer status indicating successful completion (0) or failure (non-zero).
...
*/
  ...
  //fds = WCPSst::make_fds(*tfile, tsimch); // BR 3/10/17
  if (!fds) {
