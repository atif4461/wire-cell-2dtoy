...
/** * @brief Main function to execute the Wire-Cell UBOONE signal processing pipeline.
 *
 * This function initializes geometry data sources, sets up parameters,
 * processes raw waveforms, applies deconvolution filters, performs slicing,
 * merges slices, evaluates truth, constructs matrices, solves equations,
 * performs Markov Chain Monte Carlo (MCMC) simulations, reduces blobs,
 * clusters cells, and saves the processed data to ROOT files.
 *
 * @param argc Number of command-line arguments.
 * @param argv Command-line argument array containing paths to configuration files and event numbers.
 * @return Integer status code indicating successful completion (0) or failure (non-zero).
