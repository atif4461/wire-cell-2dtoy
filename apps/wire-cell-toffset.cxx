 ...
 *
 * Initializes geometry data source, sets up parameters, reads ROOT files,
 * performs various stages of signal simulation and reconstruction including
 * deconvolution, merging, and clustering, and saves the results to output ROOT files.
 *
